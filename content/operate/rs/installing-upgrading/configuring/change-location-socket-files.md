...
for the socket files during [installation]({{< relref "/operate/rs/installing-upgrading/_index.md" >}}) or use the [following procedure](#change-socket-file-locations) after installation.
