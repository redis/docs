...
1. Identify the primary node's ID with [`rladmin cluster master`](/content/operate/rs/7.22/references/cli-utilities/rladmin/cluster/master.md):
...
1. Run [`rladmin node enslave`](/content/operate/rs/7.22/references/cli-utilities/rladmin/node/enslave.md#node-enslave) with the `demote_node` option:
...
1. To find the IDs of secondary nodes, run [`rladmin status nodes`](/content/operate/rs/7.22/references/cli-utilities/rladmin/status.md#status-nodes):
...
1. Run [`rladmin cluster master set`](/content/operate/rs/7.22/references/cli-utilities/rladmin/cluster/master.md):
