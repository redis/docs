...
keys](/content/operate/rs/7.22/clusters/configure/license-keys.md).
...
You can also configure email server settings and [send alerts by email](/content/operate/rs/7.22/monitoring/v1_monitoring.md#send-alerts-by-email) to relevant users.
