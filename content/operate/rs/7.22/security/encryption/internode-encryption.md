...
-  Use the `rladmin` command-line utility to set the [data_internode_encryption](/content/operate/rs/7.22/references/cli-utilities/rladmin/tune.md#tune-db) setting for the database:
...
- [rladmin tune cluster](/content/operate/rs/7.22/references/cli-utilities/rladmin/tune.md#tune-cluster): 
    
    ```sh
    rladmin tune cluster data_internode_encryption enabled
    ```

- [Update cluster policy](/content/operate/rs/7.22/references/rest-api/requests/cluster/policy.md#put-cluster-policy) REST API request:
...
To use the same certificate for data and control plane internode encryption, run the following [`rladmin cluster certificate`](/content/operate/rs/7.22/references/cli-utilities/rladmin/cluster/certificate.md#cluster-certificate-set-internal) command:
...
To use separate certificates for data and control plane internode encryption, run the following [`rladmin cluster certificate`](/content/operate/rs/7.22/references/cli-utilities/rladmin/cluster/certificate.md#cluster-certificate-set-internal) command:
...
To use the same certificate for data and control plane internode encryption, send a [`PUT /v1/cluster/certificates`](/content/operate/rs/7.22/references/rest-api/requests/cluster/certificates/_index.md#put-cluster-certificates) request:
...
To use separate certificates for data and control plane internode encryption, send a [`PUT /v1/cluster/certificates`](/content/operate/rs/7.22/references/rest-api/requests/cluster/certificates/_index.md#put-cluster-certificates) request:
...
- You should monitor the certificates' expiration dates and [renew them](/content/operate/rs/7.22/security/certificates/updating-certificates.md#how-to-update-certificates) before they expire.
