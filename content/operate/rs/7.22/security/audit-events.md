...
- the [REST API](/content/operate/rs/7.22/references/rest-api/requests/cluster/auditing-db-conns.md#put-cluster-audit-db-conns)
...
- the [REST API](/content/operate/rs/7.22/references/rest-api/requests/bdbs/_index.md#put-bdbs)
...
- the [REST API](/content/operate/rs/7.22/references/rest-api/requests/cluster/policy.md#put-cluster-policy)
