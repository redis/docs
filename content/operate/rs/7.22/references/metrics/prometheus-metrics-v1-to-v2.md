...
You can use the following tables to transition from v1 metrics to equivalent v2 PromQL. For a list of all available v2 metrics, see [Prometheus metrics v2](/content/operate/rs/7.22/references/metrics/prometheus-metrics-v2.md).
