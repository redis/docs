...
[setup process](/content/operate/rs/7.22/clusters/new-cluster-setup.md) was run in order to make the machine part of the cluster.
...
together with the other cluster nodes. You can [add nodes](/content/operate/rs/7.22/clusters/add-node.md), [remove nodes](/content/operate/rs/7.22/clusters/remove-node.md), or [replace nodes](/content/operate/rs/7.22/clusters/replace-node.md) as needed.
...
- [**Highly available Redis database**](/content/operate/rs/7.22/databases/durability-ha/replication.md) - Every database master shard
...
- [**Clustered Redis database**](/content/operate/rs/7.22/databases/durability-ha/clustering.md) - The data stored in the database is
    ...
    cluster, these algorithms might [migrate a shard](/content/operate/rs/7.22/databases/migrate-shards.md) between nodes.
...
You can configure [shard placement](/content/operate/rs/7.22/databases/configure/shard-placement.md) to optimize performance and availability.
...
You can configure [proxy policies](/content/operate/rs/7.22/databases/configure/proxy-policy.md) to determine which nodes' proxies are active and bound to databases.

## Database endpoint

Each database is served by a [database endpoint](/content/operate/rs/7.22/databases/connect/test-client-connectivity.md) that is part of and
...
For high availability, you can configure [private and public endpoints](/content/operate/rs/7.22/networking/private-public-endpoints.md) for your databases.
...
- Gathering [operational statistics](/content/operate/rs/7.22/monitoring/_index.md)
- Enforcing [license and subscription limitations](/content/operate/rs/7.22/clusters/configure/license-keys.md)

You can manage your Redis Enterprise Software clusters using the [Cluster Manager UI](/content/operate/rs/7.22/clusters/configure/_index.md), [command-line tools](/content/operate/rs/7.22/references/cli-utilities/_index.md), or the [REST API](/content/operate/rs/7.22/references/rest-api/_index.md).
