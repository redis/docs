...
1. Enable RESP3 support for your database (`enabled` by default):
    ...
    - [`rladmin tune db`](/content/operate/rs/7.22/references/cli-utilities/rladmin/tune.md#tune-db):
    ...
    - [Update database configuration](/content/operate/rs/7.22/references/rest-api/requests/bdbs/_index.md#put-bdbs) REST API request:
