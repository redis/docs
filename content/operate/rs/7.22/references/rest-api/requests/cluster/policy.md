...
Returns a [cluster settings object](/content/operate/rs/7.22/references/rest-api/objects/cluster_settings.md).
...
Include a [cluster settings object](/content/operate/rs/7.22/references/rest-api/objects/cluster_settings.md) with updated fields in the request body.
