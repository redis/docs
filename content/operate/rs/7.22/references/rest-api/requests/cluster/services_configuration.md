...
Returns a [services configuration object](/content/operate/rs/7.22/references/rest-api/objects/services_configuration/_index.md).
...
Include a [services configuration object](/content/operate/rs/7.22/references/rest-api/objects/services_configuration/_index.md) with updated fields in the request body.

### Response {#put-response} 

Returns the updated [services configuration object](/content/operate/rs/7.22/references/rest-api/objects/services_configuration/_index.md).
