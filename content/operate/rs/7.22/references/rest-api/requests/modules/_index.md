...
|-----------------|-------|
| [view_cluster_modules](/content/operate/rs/7.22/references/rest-api/permissions.md#view_cluster_modules) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a JSON array of [module objects](/content/operate/rs/7.22/references/rest-api/objects/module.md).
...
Returns a [module object](/content/operate/rs/7.22/references/rest-api/objects/module.md).
...
Returns a [module object](/content/operate/rs/7.22/references/rest-api/objects/module.md) with an additional `action_uid` field.
