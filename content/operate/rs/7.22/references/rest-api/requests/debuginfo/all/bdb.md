...
{{<banner-article>}}
This REST API path is deprecated as of Redis Enterprise Software version 7.4.2. Use the new path [`/v1/bdbs/debuginfo`](/content/operate/rs/7.22/references/rest-api/requests/bdbs/debuginfo.md) instead.
{{</banner-article>}}
