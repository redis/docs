...
{{<banner-article>}}
This REST API path is deprecated as of Redis Enterprise Software version 7.4.2. Use the new path [`/v1/cluster/debuginfo`](/content/operate/rs/7.22/references/rest-api/requests/cluster/debuginfo.md) instead.
{{</banner-article>}}
...
| Permission name |
|-----------------|
| [view_debugging_info](/content/operate/rs/7.22/references/rest-api/permissions.md#view_debugging_info) |
