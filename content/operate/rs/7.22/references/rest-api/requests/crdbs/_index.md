...
Returns a JSON array of [CRDB objects](/content/operate/rs/7.22/references/rest-api/objects/crdb/_index.md).
...
Returns a [CRDB object](/content/operate/rs/7.22/references/rest-api/objects/crdb/_index.md).
...
In order to add or remove instances, use [<nobr>`POST crdbs/{crdb_guid}/updates`</nobr>](/content/operate/rs/7.22/references/rest-api/requests/crdbs/updates.md#post-crdbs-updates) instead.
...
Include a [CRDB object](/content/operate/rs/7.22/references/rest-api/objects/crdb/_index.md) with updated fields in the request body.
...
Include a [CRDB object](/content/operate/rs/7.22/references/rest-api/objects/crdb/_index.md), which defines the Active-Active database, in the request body.
