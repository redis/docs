...
| Permission name |
|-----------------|
| [view_status_of_cluster_action](/content/operate/rs/7.22/references/rest-api/permissions.md#view_status_of_cluster_action) |
...
Returns a JSON array of [action objects](/content/operate/rs/7.22/references/rest-api/objects/action.md), which represent tasks, and an array of [state-machine objects](/content/operate/rs/7.22/references/rest-api/objects/state-machine.md).
...
Returns a JSON array of v2 [action objects](/content/operate/rs/7.22/references/rest-api/objects/action.md).
...
Returns an [action object](/content/operate/rs/7.22/references/rest-api/objects/action.md).
...
Returns a v2 [action object](/content/operate/rs/7.22/references/rest-api/objects/action.md).
