...
|-----------------|-------|
| [view_all_users_info](/content/operate/rs/7.22/references/rest-api/permissions.md#view_all_users_info) | admin<br />user_manager |
...
Returns a JSON array of [user objects](/content/operate/rs/7.22/references/rest-api/objects/user.md).
...
| Permission name | Roles |
|-----------------|-------|
| [view_user_info](/content/operate/rs/7.22/references/rest-api/permissions.md#view_user_info) | admin<br />user_manager |
...
Returns a [user object](/content/operate/rs/7.22/references/rest-api/objects/user.md) that contains the details for the specified user ID.
...
| Permission name | Roles |
|-----------------|-------|
| [update_user](/content/operate/rs/7.22/references/rest-api/permissions.md#update_user) | admin<br />user_manager |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |  | Validate the updated [user object](/content/operate/rs/7.22/references/rest-api/objects/user.md) but don't apply the update. |
...
Include a [user object](/content/operate/rs/7.22/references/rest-api/objects/user.md) with updated fields in the request body.

### Response {#put-response}

Returns the updated [user object](/content/operate/rs/7.22/references/rest-api/objects/user.md).
...
> [!NOTE]
> For [RBAC-enabled clusters](/content/operate/rs/7.22/security/access-control/_index.md), the returned user details include `role_uids` instead of `role`.
...
| Permission name | Roles |
|-----------------|-------|
| [create_new_user](/content/operate/rs/7.22/references/rest-api/permissions.md#create_new_user) | admin<br />user_manager |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |  | Validate the new [user object](/content/operate/rs/7.22/references/rest-api/objects/user.md) but don't apply the update. |

#### Body

Include a single [user object](/content/operate/rs/7.22/references/rest-api/objects/user.md) in the request body. The user object must have an email, password, and role.

> [!NOTE]
> For [RBAC-enabled clusters](/content/operate/rs/7.22/security/access-control/_index.md), use `role_uids` instead of `role` in the request body.
...
Returns the newly created [user object](/content/operate/rs/7.22/references/rest-api/objects/user.md).
...
| Permission name | Roles |
|-----------------|-------|
| [delete_user](/content/operate/rs/7.22/references/rest-api/permissions.md#delete_user) | admin<br />user_manager |
