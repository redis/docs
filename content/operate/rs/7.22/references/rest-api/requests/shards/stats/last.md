...
Returns most recent [statistics](/content/operate/rs/7.22/references/rest-api/objects/statistics/_index.md) for all shards.
...
Returns the most recent [statistics](/content/operate/rs/7.22/references/rest-api/objects/statistics/_index.md) for the specified shard.
