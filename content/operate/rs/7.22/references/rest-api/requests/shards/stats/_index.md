...
| Permission name |
|-----------------|
| [view_all_shard_stats](/content/operate/rs/7.22/references/rest-api/permissions.md#view_all_shard_stats) |
...
| metrics | list | Comma-separated list of [metric names](/content/operate/rs/7.22/references/rest-api/objects/statistics/shard-metrics.md) for which we want statistics (default is all) (optional) |

### Response {#get-all-response} 

Returns a JSON array of [statistics](/content/operate/rs/7.22/references/rest-api/objects/statistics/_index.md) for all shards.
...
| Permission name |
|-----------------|
| [view_shard_stats](/content/operate/rs/7.22/references/rest-api/permissions.md#view_shard_stats) |
...
Returns [statistics](/content/operate/rs/7.22/references/rest-api/objects/statistics/_index.md) for the specified shard.
