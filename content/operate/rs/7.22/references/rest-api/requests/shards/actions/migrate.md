...
For more information about shard migration use cases and considerations, see [Migrate database shards](/content/operate/rs/7.22/databases/migrate-shards.md).

#### Required permissions

| Permission name | Roles |
|-----------------|-------|
| [migrate_shard](/content/operate/rs/7.22/references/rest-api/permissions.md#migrate_shard) | admin<br />cluster_member<br />db_member |
