...
|-----------------|-------|
| [view_all_nodes_info](/content/operate/rs/7.22/references/rest-api/permissions.md#view_all_nodes_info) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a JSON array of [node objects](/content/operate/rs/7.22/references/rest-api/objects/node.md).
...
| Permission name | Roles |
|-----------------|-------|
| [view_node_info](/content/operate/rs/7.22/references/rest-api/permissions.md#view_node_info) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a [node object](/content/operate/rs/7.22/references/rest-api/objects/node.md).
...
Update a [node object](/content/operate/rs/7.22/references/rest-api/objects/node.md).
...
| Permission name | Roles |
|-----------------|-------|
| [update_node](/content/operate/rs/7.22/references/rest-api/permissions.md#update_node) | admin |
