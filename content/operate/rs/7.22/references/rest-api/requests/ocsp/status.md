...
| Permission name |
|-----------------|
| [view_ocsp_status](/content/operate/rs/7.22/references/rest-api/permissions.md#view_ocsp_status) |
...
Returns an [OCSP status object](/content/operate/rs/7.22/references/rest-api/objects/ocsp_status.md).
