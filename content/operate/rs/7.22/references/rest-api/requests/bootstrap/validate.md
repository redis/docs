...
The request must contain a [bootstrap configuration object](/content/operate/rs/7.22/references/rest-api/objects/bootstrap/_index.md), similar to the one used for actual bootstrapping.
