...
> [!WARNING]
> This endpoint is deprecated as of Redis Enterprise Software version 7.2.4 and will be removed in a future release. Use [`/v1/bdbs/<uid>/syncer_state/crdt`](/content/operate/rs/7.22/references/rest-api/requests/bdbs/syncer_state/crdt.md) instead.
