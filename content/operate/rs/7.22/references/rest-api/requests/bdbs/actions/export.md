...
|-----------------|-------|
| [start_bdb_export](/content/operate/rs/7.22/references/rest-api/permissions.md#start_bdb_export) | admin<br />cluster_member<br />db_member |
...
| Field | Type | Description |
|-------|------|-------------|
| export_location | [backup_location/export_location](/content/operate/rs/7.22/references/rest-api/objects/bdb/backup_location.md) object | Details for the export destination. Call [`GET /v1/jsonschema`](/content/operate/rs/7.22/references/rest-api/requests/jsonschema/_index.md#get-jsonschema) on the bdb object and review the `backup_location` field to retrieve the object's structure.  |
