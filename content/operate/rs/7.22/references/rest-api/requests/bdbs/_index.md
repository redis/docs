...
|-----------------|---------|
| [view_all_bdbs_info](/content/operate/rs/7.22/references/rest-api/permissions.md#view_all_bdbs_info) |  admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
The response body contains a JSON array with all databases, represented as [BDB objects](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md).
...
| Permission name | Roles |
|-----------------|-------|
| [view_bdb_info](/content/operate/rs/7.22/references/rest-api/permissions.md#view_bdb_info) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md).
...
If called with the `dry_run` URL query string, the function will validate the [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) against the existing database, but will not invoke the state machine that will update it.
...
To track this request's progress, poll the [`/actions/<action_uid>` endpoint](/content/operate/rs/7.22/references/rest-api/requests/bdbs/actions/_index.md) with the action_uid returned in the response body.

### Permissions

| Permission name | Roles |
|-----------------|-------|
| [update_bdb](/content/operate/rs/7.22/references/rest-api/permissions.md#update_bdb) | admin<br />cluster_member<br />db_member |
...
| Field   | Type | Description |
|---------|------|---------------|
| dry_run |      | Validate the new [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) but don't apply the update. |
...
Include a [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) with updated fields in the request body.
...
Returns the updated [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md).
...
| Permission name | Roles |
|-----------------|-------|
| [update_bdb_with_action](/content/operate/rs/7.22/references/rest-api/permissions.md#update_bdb_with_action) | admin<br />cluster_member<br />db_member |
...
If the request succeeds, the response body returns the updated [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md). If an error occurs, the response body may include an error code and message with more details.
...
The request must contain a single JSON [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) with the configuration parameters for the new database.
...
If passed with the `dry_run` URL query string, the function will validate the [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md), but will not invoke the state machine that will create it.
...
| Permission name | Roles |
|-----------------|-------|
| [create_bdb](/content/operate/rs/7.22/references/rest-api/permissions.md#create_bdb) | admin<br />cluster_member<br />db_member |
...
| Field | Type | Description |
|-------|------|-------------|
| dry_run |    | Validate the new [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) but don't create the database. |

#### Body

Include a [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) in the request body.
...
The response includes the newly created [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md).
...
POST /v2/bdbs
```
Create a new database in the cluster. See [`POST /v1/bdbs`](/content/operate/rs/7.22/references/rest-api/requests/bdbs/_index.md#post-bdbs-v1) for more information.
...
Include a JSON object that contains a [BDB object](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) and an optional `recovery_plan` object in the request body.
...
| Permission name | Roles |
|-----------------|-------|
| [delete_bdb](/content/operate/rs/7.22/references/rest-api/permissions.md#delete_bdb) | admin<br />cluster_member<br />db_member |
