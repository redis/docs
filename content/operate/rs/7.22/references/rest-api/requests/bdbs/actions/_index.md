...
| Method | Path | Description |
|--------|------|-------------|
| [PUT](/content/operate/rs/7.22/references/rest-api/requests/bdbs/actions/rebalance.md#put-bdbs-actions-rebalance) | `/v1/bdbs/{uid}/actions/rebalance` | Rebalance database shards |

## Recover

| Method | Path | Description |
|--------|------|-------------|
| [GET](/content/operate/rs/7.22/references/rest-api/requests/bdbs/actions/recover.md#get-bdbs-actions-recover) | `/v1/bdbs/{uid}/actions/recover` | Get database recovery plan  |
| [POST](/content/operate/rs/7.22/references/rest-api/requests/bdbs/actions/recover.md#post-bdbs-actions-recover) | `/v1/bdbs/{uid}/actions/recover` | Recover database  |

## Resume traffic
| Method | Path | Description |
|--------|------|-------------|
| [POST](/content/operate/rs/7.22/references/rest-api/requests/bdbs/actions/resume_traffic.md#post-bdbs-actions-resume-traffic) | `/v1/bdbs/{uid}/actions/resume_traffic` | Resume database traffic |

## Stop traffic
| Method | Path | Description |
|--------|------|-------------|
| [POST](/content/operate/rs/7.22/references/rest-api/requests/bdbs/actions/stop_traffic.md#post-bdbs-actions-stop-traffic) | `/v1/bdbs/{uid}/actions/stop_traffic` | Stop database traffic |
