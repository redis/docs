...
{{<banner-article>}}
This REST API path is deprecated as of Redis Enterprise Software version 7.4. Use [`PUT /v2/bdbs/<uid>`](/content/operate/rs/7.22/references/rest-api/requests/bdbs/_index.md#put-bdbs-action) instead.
{{</banner-article>}}
