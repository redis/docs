...
Alerts are bound to a cluster object (such as a [BDB](/content/operate/rs/7.22/references/rest-api/objects/bdb/_index.md) or [node](/content/operate/rs/7.22/references/rest-api/objects/node.md)), and the cluster's state determines whether the alerts turn on or off.
