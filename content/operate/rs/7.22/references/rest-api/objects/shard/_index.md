...
| backup | [backup](/content/operate/rs/7.22/references/rest-api/objects/shard/backup.md) object | Current status of scheduled periodic backup process |
...
| loading | [loading](/content/operate/rs/7.22/references/rest-api/objects/shard/loading.md) object | Current status of dump file loading |
| node_uid | string | The ID of the node this shard is located on |
| redis_info | redis_info object | A sub-dictionary of the [Redis INFO command](/content/commands/info.md) |
...
| sync | [sync](/content/operate/rs/7.22/references/rest-api/objects/shard/sync.md) object | Shard's current sync status and progress |
