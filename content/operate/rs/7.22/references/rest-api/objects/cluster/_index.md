...
|------|------------|-------------|
| alert_settings | [alert_settings](/content/operate/rs/7.22/references/rest-api/objects/cluster/alert_settings.md) object | Cluster and node alert settings |
| bigstore_driver | 'speedb'<br />'rocksdb' | Storage engine for [Auto Tiering](/content/operate/rs/7.22/databases/auto-tiering/_index.md) |
...
| logrotate_settings | [logrotate_settings](/content/operate/rs/7.22/references/rest-api/objects/cluster/logrotate_settings.md) object | Settings for logrotate configuration |
