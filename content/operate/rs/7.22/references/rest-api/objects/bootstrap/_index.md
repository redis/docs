...
| cluster | [cluster_identity](/content/operate/rs/7.22/references/rest-api/objects/bootstrap/cluster_identity.md) object | Cluster to join or create |
...
| credentials | [credentials](/content/operate/rs/7.22/references/rest-api/objects/bootstrap/credentials.md) object | Cluster admin credentials |
| dns_suffixes | {{<code>}}
[{
  "name": string,
...
| node | [node_identity](/content/operate/rs/7.22/references/rest-api/objects/bootstrap/node_identity.md) object | Node description |
| policy | [policy](/content/operate/rs/7.22/references/rest-api/objects/bootstrap/policy.md) object | Policy object |
