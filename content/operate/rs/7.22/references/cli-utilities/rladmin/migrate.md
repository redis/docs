...
Use [`rladmin status shards`](/content/operate/rs/7.22/references/cli-utilities/rladmin/status.md#status-shards) to verify the migration completed.
...
Use [`rladmin status endpoints`](/content/operate/rs/7.22/references/cli-utilities/rladmin/status.md#status-endpoints) to verify that the endpoints were moved.
