...
- Enter [`help`](/content/operate/rs/7.22/references/cli-utilities/rladmin/help.md) followed by the name of a command for a detailed explanation of the command and its usage.
