...
If you want to change the configuration of the local instance only, use [`rladmin`](/content/operate/rs/7.22/references/cli-utilities/rladmin/_index.md) instead.
...
| causal-consistency                                                  | true <br/>false                                                                                                           | [Causal consistency](/content/operate/rs/7.22/databases/active-active/causal-consistency.md) applies updates to all instances in the order they were received |
...
| default-db-config \<configuration\>                                                  |                                                                                                                               | Default database configuration from stdin. For a list of database settings, see the [CRDB database config object](/content/operate/rs/7.22/references/rest-api/objects/crdb/database_config.md) reference. |
...
| eviction-policy                                                     | noeviction<br/>allkeys-lru<br/>allkeys-lfu<br/>allkeys-random<br/>volatile-lru<br/>volatile-lfu<br/>volatile-random<br/>volatile-ttl | Updates [eviction policy](/content/operate/rs/7.22/databases/memory-performance/eviction-policy.md)                                                                                                          |
