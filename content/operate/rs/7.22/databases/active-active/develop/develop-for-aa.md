...
The default policy for Active-Active databases is _noeviction_ mode. Redis Enterprise version 6.0.20 and later support all eviction policies for Active-Active databases, unless [Auto Tiering](/content/operate/rs/7.22/databases/auto-tiering/_index.md)(previously known as Redis on Flash) is enabled.
For details, see [eviction for Active-Active databases](/content/operate/rs/7.22/databases/memory-performance/eviction-policy.md#active-active-database-eviction).
