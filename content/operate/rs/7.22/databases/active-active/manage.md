...
To change the global configuration of the Active-Active database, use [`crdb-cli`](/content/operate/rs/7.22/references/cli-utilities/crdb-cli/_index.md).

If you need to apply changes locally to one database instance, you use the Cluster Manager UI or [`rladmin`](/content/operate/rs/7.22/references/cli-utilities/rladmin/_index.md).
...
To manage the changes to Active-Active topology, use [`crdb-cli`](/content/operate/rs/7.22/references/cli-utilities/crdb-cli/_index.md) or the participating clusters list in the Cluster Manager UI.
...
Use the [`crdb-cli`](/content/operate/rs/7.22/references/cli-utilities/crdb-cli/_index.md) utility to control the size of the replication backlogs. You can set it to `auto` or set a specific size.  
