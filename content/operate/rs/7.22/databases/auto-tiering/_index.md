...
Auto Tiering is also supported on [Redis Cloud](/content/operate/rc/_index.md) and [Redis Enterprise Software for Kubernetes](/content/operate/rs/_index.md).
...
> [!NOTE]
>  Enabling Auto Tiering for [Active-Active distributed databases](/content/operate/rs/7.22/databases/active-active/_index.md) requires validating and getting the Redis technical team's approval first . 
...
- [Auto Tiering metrics](/content/operate/rs/7.22/references/metrics/auto-tiering.md)
- [Auto Tiering quick start](/content/operate/rs/7.22/databases/auto-tiering/quickstart.md)

- [Ephemeral and persistent storage](/content/operate/rs/7.22/installing-upgrading/install/plan-deployment/persistent-ephemeral-storage.md)
