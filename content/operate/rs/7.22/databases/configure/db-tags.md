...
You can add tags when you [create a database](/content/operate/rs/7.22/databases/create.md) or [edit an existing database's configuration](/content/operate/rs/7.22/databases/configure/_index.md#edit-database-settings).
