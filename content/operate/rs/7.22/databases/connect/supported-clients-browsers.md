...
For examples of each approach, see the [Redis Enterprise Software quickstart](/content/operate/rs/7.22/installing-upgrading/quickstarts/redis-enterprise-software-quickstart.md).

Note: You cannot use client libraries to configure Redis Enterprise Software.  Instead, use:

- The Redis Enterprise Software [Cluster Manager UI](/content/operate/rs/7.22/installing-upgrading/quickstarts/redis-enterprise-software-quickstart.md)
- The [REST API](/content/operate/rs/7.22/references/rest-api/_index.md)
- Command-line utilities, such as [`rladmin`](/content/operate/rs/7.22/references/cli-utilities/rladmin/_index.md)

### Discovery service

We recommend the following clients when using a [discovery service](/content/operate/rs/7.22/databases/durability-ha/discovery-service.md) based on the Redis Sentinel API:
