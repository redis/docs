...
After you [set up a cluster](/content/operate/rs/7.22/clusters/new-cluster-setup.md) and [create a Redis database](/content/operate/rs/7.22/databases/create.md), you can connect to your database.
...
If you try to connect with the FQDN, and the database does not respond, try connecting with the IP address. If this succeeds, DNS is not properly configured. To set up DNS, see [Configure cluster DNS](/content/operate/rs/7.22/networking/cluster-dns.md).

If you want to secure your connection, set up [TLS](/content/operate/rs/7.22/security/encryption/tls/_index.md).

## Connect to a database

Use one of the following connection methods to connect to your database:

- [`redis-cli`](/content/operate/rs/7.22/references/cli-utilities/redis-cli/_index.md) utility

- [Redis Insight](https://redis.com/redis-enterprise/redis-insight/)

- [Redis client](/content/develop/clients/_index.md) for your preferred programming language

For examples, see [Test client connection](/content/operate/rs/7.22/databases/connect/test-client-connectivity.md).
