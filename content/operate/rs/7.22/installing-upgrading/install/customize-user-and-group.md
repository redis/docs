...
To customize the user or group during [installation](/content/operate/rs/7.22/installing-upgrading/install/install-on-linux.md), include the `--os-user` or `--os-group` [command-line options](/content/operate/rs/7.22/installing-upgrading/install/install-script.md) when you run the `install.sh` script.
