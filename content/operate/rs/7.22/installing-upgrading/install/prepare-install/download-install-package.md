...
> review the [configuration requirements for AWS EC2 instances](/content/operate/rs/7.22/installing-upgrading/install/plan-deployment/configuring-aws-instances.md).
