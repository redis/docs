...
To install Redis Enterprise Software on a [supported platform](/content/operate/rs/7.22/installing-upgrading/install/plan-deployment/supported-platforms.md), you need to:

1. [Plan your deployment](/content/operate/rs/7.22/installing-upgrading/install/plan-deployment/_index.md).

1. [Prepare to install](/content/operate/rs/7.22/installing-upgrading/install/prepare-install/_index.md).

1. [Perform the install](/content/operate/rs/7.22/installing-upgrading/install/_index.md).
...
- [Upgrade a cluster](/content/operate/rs/7.22/installing-upgrading/upgrading/upgrade-cluster.md)

- [Upgrade a database](/content/operate/rs/7.22/installing-upgrading/upgrading/upgrade-database.md)

- [Upgrade an Active-Active database](/content/operate/rs/7.22/installing-upgrading/upgrading/upgrade-active-active.md)

## Uninstall Redis Enterprise Software

- [Uninstall existing deployment](/content/operate/rs/7.22/installing-upgrading/uninstalling.md)
...
- [Linux swap space configuration](/content/operate/rs/7.22/installing-upgrading/configuring/linux-swap.md)
