...
During Redis Enterprise Software installation, the [installer prompts](/content/operate/rs/7.22/installing-upgrading/install/manage-installation-questions.md) you to confirm auto-configuration of a default (public) zone
...
> [!NOTE]
> If databases are created with non-standard [Redis Enterprise Software ports](/content/operate/rs/7.22/networking/port-configurations.md),
