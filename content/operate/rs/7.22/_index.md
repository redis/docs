...
- [Linux quickstart](/content/operate/rs/7.22/installing-upgrading/quickstarts/redis-enterprise-software-quickstart.md)
...
## Install & setup
[Install & set up](/content/operate/rs/7.22/installing-upgrading/_index.md) a Redis Enterprise Software cluster.
- [Networking](/content/operate/rs/7.22/networking/_index.md)
- [Set up](/content/operate/rs/7.22/clusters/new-cluster-setup.md) & [configure](/content/operate/rs/7.22/clusters/configure/_index.md) a [cluster](/content/operate/rs/7.22/clusters/_index.md)
- [Release notes](/content/operate/rs/release-notes/_index.md)

## Databases
Create and manage a [Redis database](/content/operate/rs/7.22/databases/_index.md) on a cluster.
- [Create a Redis Enterprise Software database](/content/operate/rs/7.22/databases/create.md)
- [Configure database](/content/operate/rs/7.22/databases/configure/_index.md)
- [Create Active-Active database](/content/operate/rs/7.22/databases/active-active/create.md)
- [Edit Active-Active database](/content/operate/rs/7.22/databases/active-active/manage.md)

## Security
[Manage secure connections](/content/operate/rs/7.22/security/_index.md) to the cluster and databases.
- [Access control](/content/operate/rs/7.22/security/access-control/_index.md)
- [Users](/content/operate/rs/7.22/security/access-control/manage-users/_index.md) & [roles](/content/operate/rs/7.22/security/access-control/_index.md)
- [Certificates](/content/operate/rs/7.22/security/certificates/_index.md)
- [TLS](/content/operate/rs/7.22/security/encryption/tls/_index.md) & [Encryption](/content/operate/rs/7.22/security/encryption/_index.md)
