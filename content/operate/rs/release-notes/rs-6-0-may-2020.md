...
For more information, check out the [Redis Enterprise Software user management documentation]({{< relref "/operate/rs/security/access-control/create-roles/create-db-roles" >}}).
