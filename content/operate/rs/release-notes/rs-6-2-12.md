...
- Session and security attributes in the admin console
    ...
    You can now use the admin console to configure [password complexity rules](/content/operate/rs/security/access-control/manage-passwords/_index.md#password-complexity-rules), [user login lockout](/operate/rs/security/access-control/manage-users/login-lockout/#user-login-lockout), and [session timeout](/operate/rs/security/access-control/manage-users/login-lockout/#session-timeout).  
