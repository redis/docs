...
Redis Software version 8.0.18-36 supports Red Hat OpenShift Virtualization 4.x.

Run Redis Software on virtual machines managed by OpenShift Virtualization using RHEL 9 or a compatible distribution as the guest operating system. Install and configure the cluster the same way you would on any other supported platform. For operating system compatibility details, see the [supported platforms reference](/content/operate/rs/references/supported-platforms.md).
