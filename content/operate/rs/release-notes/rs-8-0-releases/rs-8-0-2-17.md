---
Title: Redis Enterprise Software release notes 8.0.2-17 (October 2025)
alwaysopen: false
categories:
- docs
- operate
...
Redis Enterprise Software version 8.0.2 includes five Redis database versions: 8.2.1, 8.0.2, 7.4.3, 7.2.7, and 6.2.13.
...
Redis Enterprise Software 8.0.2-17 supports Redis Open Source 8.2, 8.0, 7.4, 7.2, and 6.2. Below is the list of Redis Open Source CVEs and other security vulnerabilities fixed by version.
