...
- Added license information to [usage reports](/content/operate/rs/references/rest-api/requests/usage_report/_index.md), including activation date, expiration date, shard limits, and shard usage.
