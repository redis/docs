---
Title: Redis Software release notes 8.0.18-tba (April 2026)
alwaysopen: false
categories:
- docs
- operate
...
linkTitle: 8.0.18-tba (April 2026)
weight: 83
---
...
| Package | SHA256 checksum (8.0.18-tba April release) |
|---------|---------------------------------------|
...
Redis Software 8.0.18-tba supports Redis Open Source 8.4, 8.2, 8.0, 7.4, 7.2, and 6.2. Below is the list of Redis Open Source CVEs and other security vulnerabilities fixed by version.
