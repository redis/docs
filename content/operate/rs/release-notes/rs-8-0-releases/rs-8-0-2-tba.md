---
Title: Redis Enterprise Software release notes 8.0.2-tba (November 2025)
alwaysopen: false
categories:
- docs
- operate
...
This is a maintenance release for ​[​Redis Enterprise Software version 8.0.2](https://redis.io/downloads/#Redis_Software).
...
| Package | SHA256 checksum (8.0.2-tba November release) |
|---------|---------------------------------------|
...
Redis Enterprise Software 8.0.2-tba supports Redis Open Source 8.2, 8.0, 7.4, 7.2, and 6.2. Below is the list of Redis Open Source CVEs and other security vulnerabilities fixed by version.
