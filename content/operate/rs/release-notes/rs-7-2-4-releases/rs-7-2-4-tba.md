---
Title: Redis Enterprise Software release notes 7.2.4-tba (February 2025)
alwaysopen: false
categories:
- docs
- operate
...
linkTitle: 7.2.4-tba (February 2025)
weight: 66
---
...
- [RediSearch 2.8]({{< baseurl >}}operate/oss_and_stack/stack-with-enterprise/release-notes/redisearch/redisearch-2.8-release-notes)

- [RedisJSON 2.6]({{< baseurl >}}operate/oss_and_stack/stack-with-enterprise/release-notes/redisjson/redisjson-2.6-release-notes)

- [RedisTimeSeries 1.10]({{< baseurl >}}operate/oss_and_stack/stack-with-enterprise/release-notes/redistimeseries/redistimeseries-1.10-release-notes)

- [RedisBloom 2.6]({{< baseurl >}}operate/oss_and_stack/stack-with-enterprise/release-notes/redisbloom/redisbloom-2.6-release-notes)
