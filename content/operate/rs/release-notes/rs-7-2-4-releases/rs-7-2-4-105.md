...
- LDAP authentication timeout `directory_timeout_s` is now configurable using a [`PUT /v1/cluster/ldap`](/content/operate/rs/references/rest-api/requests/cluster/ldap.md#put-cluster-ldap) REST API request.
...
9. <a name="table-note-9" style="display: block; height: 80px; margin-top: -80px;"></a>Redis Enterprise Software [7.2.4-105](/content/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-105.md) and later supports RHEL 8.9.
