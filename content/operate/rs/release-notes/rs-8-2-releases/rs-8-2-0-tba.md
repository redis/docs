---
Title: Redis Software release notes 8.2.0-tba (July 2026)
alwaysopen: false
categories:
- docs
- operate
...
| Package | SHA256 checksum (8.2.0-tba July release) |
|---------|---------------------------------------|
...
Redis Software 8.2.0-tba supports Redis Open Source 8.6, 8.4, 8.2, 8.0, 7.4, 7.2, and 6.2. Below is the list of Redis Open Source CVEs and other security vulnerabilities fixed by version.
