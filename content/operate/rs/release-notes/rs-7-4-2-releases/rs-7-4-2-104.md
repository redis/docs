...
- [RediSearch 2.8.11](/content/operate/oss_and_stack/stack-with-enterprise/release-notes/redisearch/redisearch-2.8-release-notes.md)
...
- [RedisBloom 2.6.11](/content/operate/oss_and_stack/stack-with-enterprise/release-notes/redisbloom/redisbloom-2.6-release-notes.md)
...
- [RediSearch 2.6.15](/content/operate/oss_and_stack/stack-with-enterprise/release-notes/redisearch/redisearch-2.6-release-notes.md)
...
- [RedisBloom 2.4.8](/content/operate/oss_and_stack/stack-with-enterprise/release-notes/redisbloom/redisbloom-2.4-release-notes.md)
...
- The BDB REST API object's `background_op` field is deprecated. Use [`GET v1/actions/bdb/<bdb_uid>`](/content/operate/rs/references/rest-api/requests/actions/bdb.md) instead.
