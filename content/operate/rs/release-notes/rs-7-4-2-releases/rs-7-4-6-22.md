...
- Added an option to the [optimize_shards_placement](/content/operate/rs/references/rest-api/requests/bdbs/actions/optimize_shards_placement.md) REST API request to consider replication when calculating the database’s optimized shard placement.
...
| [**End-of-life date**](/content/operate/rs/installing-upgrading/product-lifecycle.md#endoflife-schedule) | Determined after<br />next major release | Feb 2026 | Aug 2025 | Feb 2025 |
| **Platforms** | | | | |
