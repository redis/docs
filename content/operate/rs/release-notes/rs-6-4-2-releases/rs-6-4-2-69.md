...
- RS99643 - Fix [`cipher_suites`]({{< relref "/operate/rs/security/encryption/tls/ciphers" >}}) configuration to allow default cipher suites according to the [control plane]({{< relref "/operate/rs/security/encryption/tls/ciphers#control-plane" >}}), [data plane]({{< relref "/operate/rs/security/encryption/tls/ciphers#data-plane" >}}), and [discovery service]({{< relref "/operate/rs/security/encryption/tls/ciphers#discovery-service" >}}).
