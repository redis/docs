...
- Added support for Ubuntu 22. See [Upgrade a cluster's operating system](/content/operate/rs/installing-upgrading/upgrading/upgrade-os.md) for detailed upgrade instructions.
