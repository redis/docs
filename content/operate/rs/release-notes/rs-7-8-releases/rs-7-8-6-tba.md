---
Title: Redis Software release notes 7.8.6-tba (April 2026)
alwaysopen: false
categories:
- docs
- operate
...
linkTitle: 7.8.6-tba (April 2026)
weight: 76
---
...
| Package | SHA256 checksum (7.8.6-tba April release) |
|---------|---------------------------------------|
...
Redis Software 7.8.6-tba supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs and other security vulnerabilities fixed by version.
