---
Title: Redis Enterprise Software release notes 7.8.6-tba (May 2025)
alwaysopen: false
categories:
- docs
- operate
...
description: Performance improvements for the Cluster Manager UI's nodes screen. Bug fix for slowness and intermittent failures in the Cluster Manager UI, `rladmin`, and `rlcheck` after upgrading large clusters to version 7.8.4.
linkTitle: 7.8.6-tba (May 2025)
weight: 82
---
...
| Package | SHA256 checksum (7.8.6-tba May release) |
|---------|---------------------------------------|
