---
Title: Redis Enterprise Software release notes 7.8.6-tba (July 2025)
alwaysopen: false
categories:
- docs
- operate
...
| Package | SHA256 checksum (7.8.6-tba July release) |
|---------|---------------------------------------|
...
Redis Software 7.8.6-tba supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs fixed by version.
