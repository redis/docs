...
- Performance improvements:
    ...
    - This version includes major performance improvements, which improves mostly low end environments (2,4 or 8 cores VMs) and single shard (non clustered) databases.
