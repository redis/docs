...
description: Bug fix for a node join failures due to misidentified IPv6 addresses. Bug fix for -MOVED response metrics visibility. Internal fixes and improvements.
