---
Title: Redis Enterprise Software release notes 7.22.0-52 (May 2025)
alwaysopen: false
categories:
- docs
- operate
...
| Package | SHA256 checksum (7.22.0-52 May release) |
|---------|---------------------------------------|
...
Redis Enterprise Software 7.22.0-52 supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs fixed by version.
