---
Title: Redis Enterprise Software release notes 7.22.2-41 (November 2025)
alwaysopen: false
categories:
- docs
- operate
...
Redis Enterprise Software version 7.22.2 includes three Redis database versions: 7.4.3, 7.2.7, and 6.2.13.
...
Redis Enterprise Software 7.22.2-41 supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs and other security vulnerabilities fixed by version.
