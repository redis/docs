---
Title: Redis Enterprise Software release notes 7.22.2-tba (September 2025)
alwaysopen: false
categories:
- docs
- operate
...
description: Customer-managed certificates for internode encryption.
linkTitle: 7.22.2-tba (September 2025)
weight: 86
---
...
| Package | SHA256 checksum (7.22.2-tba September release) |
|---------|---------------------------------------|
...
Redis Enterprise Software 7.22.2-tba supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs fixed by version.
