---
Title: Redis Enterprise Software release notes 7.22.2-tba (November 2025)
alwaysopen: false
categories:
- docs
- operate
...
linkTitle: 7.22.2-tba (November 2025)
weight: 84
---

This is a maintenance release for ​​Redis Enterprise Software version 7.22.2.
...
| Package | SHA256 checksum (7.22.2-tba November release) |
|---------|---------------------------------------|
...
Redis Enterprise Software 7.22.2-tba supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs and other security vulnerabilities fixed by version.
