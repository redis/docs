---
Title: Redis Enterprise Software release notes 7.2x.x
alwaysopen: false
categories:
- docs
- operate
...
description: TBA
hideListLinks: true
linkTitle: 7.2x.x releases
toc: 'true'
weight: 67
---

​[​Redis Enterprise Software version 7.2x](https://redis.io/downloads/#software) is now available!
