...
The fully qualified domain name (FQDN) is the unique cluster identifier that enables clients to connect to database endpoints and API-s of the Redis Enterprise Software cluster.
