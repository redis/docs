...
| <span class="break-all">oss_cluster_client_maint_notifications</span> | boolean (default: false) | Toggles sending client maintenance notifications about shard movements to clients connected through the [OSS Cluster API]({{<relref "/operate/rs/databases/configure/oss-cluster-api">}}) |
