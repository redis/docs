...
| <span class="break-all">oss_cluster_api_preferred_ip_type</span> | **'internal'** <br />'external'; Internal/external IP type in OSS cluster API. Default value for new endpoints |
