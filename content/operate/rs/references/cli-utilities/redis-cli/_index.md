...
If you want to run Redis commands without `redis-cli`, you can [connect to a database with RedisInsight]({{< relref "/develop/connect/insight/" >}}) and use the built-in [CLI]({{< relref "/develop/get-started/" >}}insight/#cli) prompt instead.
...
- [Open source Redis]({{< relref "/operate/oss_and_stack/stack-with-enterprise/install/" >}}installation/)
