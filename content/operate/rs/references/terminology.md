...
[setup process](/content/operate/rs/clusters/new-cluster-setup.md) was run in order to make the machine part of the cluster.
...
together with the other cluster nodes. You can [add nodes](/content/operate/rs/clusters/add-node.md), [remove nodes](/content/operate/rs/clusters/remove-node.md), or [replace nodes](/content/operate/rs/clusters/replace-node.md) as needed.
...
- [**Highly available Redis database**](/content/operate/rs/databases/durability-ha/replication.md) - Every database master shard
...
- [**Clustered Redis database**](/content/operate/rs/databases/durability-ha/clustering.md) - The data stored in the database is
    ...
    cluster, these algorithms might [migrate a shard](/content/operate/rs/databases/migrate-shards.md) between nodes.
...
You can configure [shard placement](/content/operate/rs/databases/configure/shard-placement.md) to optimize performance and availability.
...
You can configure [proxy policies](/content/operate/rs/databases/configure/proxy-policy.md) to determine which nodes' proxies are active and bound to databases.

## Database endpoint

Each database is served by a [database endpoint](/content/operate/rs/databases/connect/test-client-connectivity.md) that is part of and
...
For high availability, you can configure [private and public endpoints](/content/operate/rs/networking/private-public-endpoints.md) for your databases.
...
- Gathering [operational statistics](/content/operate/rs/monitoring/_index.md)
- Enforcing [license and subscription limitations](/content/operate/rs/clusters/configure/license-keys.md)

You can manage your Redis Software clusters using the [Cluster Manager UI](/content/operate/rs/clusters/configure/_index.md), [command-line tools](/content/operate/rs/references/cli-utilities/_index.md), or the [REST API](/content/operate/rs/references/rest-api/_index.md).
