...
For a list of all available v2 metrics, see [Prometheus metrics v2](/content/operate/rs/7.8/references/metrics/prometheus-metrics-v2.md).
...
1. Use the metrics tables in [this guide](/content/operate/rs/7.8/references/metrics/prometheus-metrics-v1-to-v2.md) to transition from v1 metrics to equivalent v2 PromQL.
