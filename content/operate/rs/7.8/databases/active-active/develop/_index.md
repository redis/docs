...
[Learn more about
synchronization for
each supported data type](/content/operate/rs/7.8/databases/active-active/develop/data-types/_index.md) and [how to develop applications](/content/operate/rs/7.8/databases/active-active/develop/develop-for-aa.md) with them on Redis Enterprise Software.
