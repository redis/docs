...
The [shard placement policy](/content/operate/rs/7.8/databases/memory-performance/shard-placement-policy.md) helps to maintain optimal performance and resiliency.
