...
When saved to a local mount point or a cloud provider, export locations need to be available to [the group and user](/content/operate/rs/7.8/installing-upgrading/install/customize-user-and-group.md) running Redis Enterprise Software, `redislabs:redislabs` by default.  
