...
The default policy for [Active-Active databases](/content/operate/rs/7.8/databases/active-active/_index.md) is _noeviction_ policy.
...
For larger databases, consider using [Auto Tiering ](/content/operate/rs/7.8/databases/auto-tiering/_index.md).
