...
1. Review the [access control overview](/content/operate/rs/7.8/security/access-control/_index.md) to learn how to use role-based access control (RBAC) to manage users' cluster access and database access.
...
- [Connect to a database](/content/operate/rs/7.8/databases/connect/_index.md) associated with the role and run limited Redis commands, depending on the role's Redis ACLs.

- Sign in to the Redis Enterprise Software Cluster Manager UI.

- Make a [REST API](/content/operate/rs/7.8/references/rest-api/_index.md) request.
