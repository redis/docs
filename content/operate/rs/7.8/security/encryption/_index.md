...
You can also [enable TLS authentication](/content/operate/rs/7.8/security/encryption/tls/enable-tls.md) for the following:
...
- Communication to and from your database to other clusters for [Active-Active](/content/operate/rs/7.8/databases/active-active/_index.md) synchronization
...
By default, the Redis Enterprise Software API supports communication over HTTP and HTTPS. However, you can [turn off HTTP support](/content/operate/rs/7.8/references/rest-api/encryption.md) to ensure that API requests are encrypted.
...
Enable PEM encryption to [encrypt all private keys](/content/operate/rs/7.8/security/encryption/pem-encryption.md) on disk.
