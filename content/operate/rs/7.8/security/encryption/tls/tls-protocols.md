...
- Discovery service (Sentinel) - The TLS configuration for the [discovery service](/content/operate/rs/7.8/databases/durability-ha/discovery-service.md).

You can configure TLS protocols with the [Cluster Manager UI](#edit-tls-ui), [`rladmin`](/content/operate/rs/7.8/references/cli-utilities/rladmin/cluster/config.md), or the [REST API](/content/operate/rs/7.8/references/rest-api/requests/cluster/_index.md#put-cluster).
