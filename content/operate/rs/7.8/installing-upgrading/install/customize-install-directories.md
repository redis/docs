...
To specify directories during [installation](/content/operate/rs/7.8/installing-upgrading/install/install-on-linux.md), include installer flags as [command-line options](/content/operate/rs/7.8/installing-upgrading/install/install-script.md) when you run the `install.sh` script. For example:
