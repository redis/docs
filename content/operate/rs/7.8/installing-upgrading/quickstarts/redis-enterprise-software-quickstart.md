...
> For production environments, see the [install and setup](/content/operate/rs/7.8/installing-upgrading/_index.md#install-redis-enterprise-software) guide for deployment options and instructions.
...
See [Test client connection](/content/operate/rs/7.8/databases/connect/test-client-connectivity.md) for connection options and examples.
