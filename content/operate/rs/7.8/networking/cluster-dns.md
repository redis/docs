...
When using the IP-based connection method, you can use the [Discovery Service](/content/operate/rs/7.8/databases/durability-ha/discovery-service.md)
...
To test your connection, try pinging the service.  For help, see [Connect to your database](/content/operate/rs/7.8/databases/connect/test-client-connectivity.md).
