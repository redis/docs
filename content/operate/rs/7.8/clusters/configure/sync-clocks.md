...
If you are using Active-Active databases, you must use [Network Time Service (ntpd)](/content/operate/rs/7.8/databases/active-active/_index.md#network-time-service-ntp-or-chrony)
