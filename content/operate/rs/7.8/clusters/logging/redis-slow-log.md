...
- Cluster Manager UI:
    ...
    1. To access the slow log in the Cluster Manager UI, your [cluster management role](/content/operate/rs/7.8/security/access-control/create-cluster-roles.md) must be Admin, Cluster Member, or DB Member.
...
- Command line:
    ...
    Use [`redis-cli`](/content/operate/rs/7.8/references/cli-utilities/redis-cli/_index.md) to run [`SLOWLOG GET`](/content/commands/slowlog-get.md):
...
The slow log includes all database commands that take longer than ten milliseconds (10,000 microseconds) by default. You can use [`redis-cli`](/content/operate/rs/7.8/references/cli-utilities/redis-cli/_index.md) to view or change this threshold.
...
The slow log retains the last 128 entries by default. You can use [`redis-cli`](/content/operate/rs/7.8/references/cli-utilities/redis-cli/_index.md) to view or change the maximum number of entries.
