...
For more about working with the OSS Cluster API in Redis Enterprise Software, see [Enable OSS Cluster API](/content/operate/rs/7.8/databases/configure/oss-cluster-api.md). 
