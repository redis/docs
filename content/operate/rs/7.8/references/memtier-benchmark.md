...
- [Redis Enterprise Software quickstart](/content/operate/rs/7.8/installing-upgrading/quickstarts/redis-enterprise-software-quickstart.md) for a test installation
- [Install and upgrade](/content/operate/rs/7.8/installing-upgrading/_index.md) for a production installation
