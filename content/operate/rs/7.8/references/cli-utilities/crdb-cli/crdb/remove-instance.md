...
1. Run [`crdb-cli crdb purge-instance`](/content/operate/rs/7.8/references/cli-utilities/crdb-cli/crdb/purge-instance.md) from the removed instance to delete the Active-Active database and its data.
...
| force                        |        | Removes the instance without purging data from the instance. <br>If --force is specified, you must run [`crdb-cli crdb purge-instance`](/content/operate/rs/7.8/references/cli-utilities/crdb-cli/crdb/purge-instance.md) from the removed instance. |
