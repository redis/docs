...
Configures [quorum-only mode](/content/operate/rs/7.8/clusters/maintenance-mode.md#activate-maintenance-mode) on a node.
...
Use [`rladmin status nodes`](/content/operate/rs/7.8/references/cli-utilities/rladmin/status.md#status-nodes) to verify the node became a quorum node.
...
Use [`rladmin status nodes`](/content/operate/rs/7.8/references/cli-utilities/rladmin/status.md#status-nodes) to verify the node was restored.
