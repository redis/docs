...
| bigstore_driver | 'ibm-capi-ga1'<br />'ibm-capi-ga2'<br />'ibm-capi-ga4'<br />'speedb'<br />'rocksdb' | Bigstore driver name or none (deprecated as of Redis Enterprise v7.2, use the [cluster object](/content/operate/rs/7.8/references/rest-api/objects/cluster/_index.md)'s `bigstore_driver` instead) |
| bigstore_enabled | boolean | If `true`, then flash storage is enabled on this node for [Auto Tiering](/content/operate/rs/7.8/databases/auto-tiering/_index.md) databases. Configurable during [bootstrapping](/content/operate/rs/7.8/references/rest-api/requests/bootstrap/_index.md#post-bootstrap). After bootstrapping, it is read-only. |
