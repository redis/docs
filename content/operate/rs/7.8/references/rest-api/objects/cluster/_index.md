...
|------|------------|-------------|
| alert_settings | [alert_settings](/content/operate/rs/7.8/references/rest-api/objects/cluster/alert_settings.md) object | Cluster and node alert settings |
| bigstore_driver | 'speedb'<br />'rocksdb' | Storage engine for [Auto Tiering](/content/operate/rs/7.8/databases/auto-tiering/_index.md) |
