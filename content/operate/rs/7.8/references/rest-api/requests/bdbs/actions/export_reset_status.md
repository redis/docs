...
|-----------------|-------|
| [reset_bdb_current_export_status](/content/operate/rs/7.8/references/rest-api/permissions.md#reset_bdb_current_export_status) | admin<br />cluster_member<br />db_member |
