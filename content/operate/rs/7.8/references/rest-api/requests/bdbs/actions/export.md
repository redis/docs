...
|-----------------|-------|
| [start_bdb_export](/content/operate/rs/7.8/references/rest-api/permissions.md#start_bdb_export) | admin<br />cluster_member<br />db_member |
