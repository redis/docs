...
Returns [statistics](/content/operate/rs/7.8/references/rest-api/objects/statistics/_index.md) for all CRDB peer instances.
...
Returns [statistics](/content/operate/rs/7.8/references/rest-api/objects/statistics/_index.md) for a specific CRDB peer instance.
