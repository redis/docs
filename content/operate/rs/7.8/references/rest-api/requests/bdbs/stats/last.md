...
|-----------------|-------|
| [view_all_bdb_stats](/content/operate/rs/7.8/references/rest-api/permissions.md#view_all_bdb_stats) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns [statistics](/content/operate/rs/7.8/references/rest-api/objects/statistics/_index.md) for all databases.
...
| Permission name | Roles |
|-----------------|-------|
| [view_bdb_stats](/content/operate/rs/7.8/references/rest-api/permissions.md#view_bdb_stats) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns the most recent [statistics](/content/operate/rs/7.8/references/rest-api/objects/statistics/_index.md) for a specific database.
