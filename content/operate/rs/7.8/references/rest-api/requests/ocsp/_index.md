...
| Permission name |
|-----------------|
| [view_ocsp_config](/content/operate/rs/7.8/references/rest-api/permissions.md#view_ocsp_config) |
...
Returns an [OCSP configuration object](/content/operate/rs/7.8/references/rest-api/objects/ocsp.md).
...
| Permission name |
|-----------------|
| [config_ocsp](/content/operate/rs/7.8/references/rest-api/permissions.md#config_ocsp) |
...
Include an [OCSP configuration object](/content/operate/rs/7.8/references/rest-api/objects/ocsp.md) with updated fields in the request body.

### Response {#put-response} 

Returns the updated [OCSP configuration object](/content/operate/rs/7.8/references/rest-api/objects/ocsp.md).
