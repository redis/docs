...
Upgrades the module version on a specific database. Deprecated as of Redis Enterprise Software v7.8.2. Use [`POST /v1/bdbs/<uid>/upgrade`](/content/operate/rs/7.8/references/rest-api/requests/bdbs/upgrade.md#post-bdbs-upgrade) instead.

#### Required permissions

| Permission name |
|-----------------|
| [edit_bdb_module](/content/operate/rs/7.8/references/rest-api/permissions.md#edit_bdb_module) |
...
Returns the upgraded [module object](/content/operate/rs/7.8/references/rest-api/objects/module.md).
