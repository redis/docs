...
The `local_node_info` object is a subset of a [node object](/content/operate/rs/7.8/references/rest-api/objects/node.md) that provides information about the node configuration.
...
described in [Object attributes](/content/operate/rs/7.8/references/rest-api/objects/_index.md) or a minimal subset.
...
Include a [bootstrap object](/content/operate/rs/7.8/references/rest-api/objects/bootstrap/_index.md) in the request body.
