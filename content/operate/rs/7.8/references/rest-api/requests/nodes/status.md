...
| Permission name |
|-----------------|
| [view_node_info](/content/operate/rs/7.8/references/rest-api/permissions.md#view_node_info) |
...
If a maintenance snapshot exists due to an in-progress or improperly stopped [node maintenance](/content/operate/rs/7.8/clusters/maintenance-mode.md) process, the response includes a `maintenance_snapshot` field.
