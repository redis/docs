...
|-----------------|-------|
| [view_cluster_info](/content/operate/rs/7.8/references/rest-api/permissions.md#view_cluster_info) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns a [job_scheduler object](/content/operate/rs/7.8/references/rest-api/objects/job_scheduler/_index.md).
...
Include a [job_scheduler object](/content/operate/rs/7.8/references/rest-api/objects/job_scheduler/_index.md) with updated fields in the request body.

### Response {#put-response}

Returns a [job_scheduler object](/content/operate/rs/7.8/references/rest-api/objects/job_scheduler/_index.md) with the updated fields.
