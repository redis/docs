...
| Permission name |
|-----------------|
| [view_cluster_stats](/content/operate/rs/7.8/references/rest-api/permissions.md#view_cluster_stats) |
...
Returns the most recent [statistics](/content/operate/rs/7.8/references/rest-api/objects/statistics/_index.md) for the cluster.
