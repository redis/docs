...
| Permission name |
|-----------------|
| [view_status_of_cluster_action](/content/operate/rs/7.8/references/rest-api/permissions.md#view_status_of_cluster_action) |
...
Returns a JSON array of [action objects](/content/operate/rs/7.8/references/rest-api/objects/action.md). 
...
Returns an [action object](/content/operate/rs/7.8/references/rest-api/objects/action.md). 
...
| Permission name |
|-----------------|
| [start_cluster_action](/content/operate/rs/7.8/references/rest-api/permissions.md#start_cluster_action) |
...
| Permission name |
|-----------------|
| [cancel_cluster_action](/content/operate/rs/7.8/references/rest-api/permissions.md#cancel_cluster_action) |
