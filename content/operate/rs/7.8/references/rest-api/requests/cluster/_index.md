...
Returns a [cluster object](/content/operate/rs/7.8/references/rest-api/objects/cluster/_index.md).
...
validate the [cluster object](/content/operate/rs/7.8/references/rest-api/objects/cluster/_index.md), but will not apply the requested
changes.
...
Include a [cluster object](/content/operate/rs/7.8/references/rest-api/objects/cluster/_index.md) with updated fields in the request body.
