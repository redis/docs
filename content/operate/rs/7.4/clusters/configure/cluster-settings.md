...
keys](/content/operate/rs/7.4/clusters/configure/license-keys.md).
...
You can also configure email server settings and [send alerts by email](/content/operate/rs/7.4/clusters/monitoring/_index.md#send-alerts-by-email) to relevant users.
