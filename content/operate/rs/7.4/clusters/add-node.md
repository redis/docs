...
>
> - The clocks on all nodes must always be [synchronized](/content/operate/rs/7.4/clusters/configure/sync-clocks.md).
>
...
>
> - You must [update the DNS records](/content/operate/rs/7.4/networking/cluster-dns.md)
...
1. [Install the Redis Enterprise Software installation package](/content/operate/rs/7.4/installing-upgrading/_index.md) on a clean installation
    of a [supported operating system](/content/operate/rs/7.4/installing-upgrading/install/plan-deployment/supported-platforms.md).
...
1. To connect to the Cluster Manager UI of the new Redis Enterprise Software installation, go to: <https://URL or IP address:8443>
    ...
    > You can also [replace the TLS certificate](/content/operate/rs/7.4/security/certificates/updating-certificates.md)
...
> [!TIP]
> We recommend that you run the [rlcheck utility](/content/operate/rs/7.4/references/cli-utilities/rlcheck/_index.md) to verify that the node is functioning properly.
