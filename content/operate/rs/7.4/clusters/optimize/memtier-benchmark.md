...
For help with the prerequisites, see the [Redis Enterprise Software quickstart](/content/operate/rs/7.4/installing-upgrading/quickstarts/redis-enterprise-software-quickstart.md).
