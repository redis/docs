...
To change the cluster's `failure_detection_sensitivity`, run one of the following [`rladmin`](/content/operate/rs/7.4/references/cli-utilities/rladmin/tune.md#tune-cluster) commands.
