...
You can also [manage your logs](/content/operate/rs/7.4/clusters/logging/log-security.md) with a remote logging server and log rotation.
...
Log entries include information about the specific event that occurred. See the log entry tables for [alerts and events](/content/operate/rs/7.4/clusters/logging/alerts-events.md) for more details.
...
- **list of key-value pairs in any order**:­ A list of key-value pairs that describe the specific event. They can appear in any order. Some key­-value pairs are always shown, and some appear depending on the specific event.
    - **Key-­value pairs that always appear:**
        - `"type"`: A unique code­ name for the logged event. For the list of codenames, see the [logged alerts and events](/content/operate/rs/7.4/clusters/logging/alerts-events.md) tables.
...
- `"type":"ephemeral_storage"` - The code name of this specific event. See [logged alerts and events](/content/operate/rs/7.4/clusters/logging/alerts-events.md) for more details.
...
- `"type":"ephemeral_storage"` -­ The code name identifier of this specific event. See [logged alerts and events](/content/operate/rs/7.4/clusters/logging/alerts-events.md) for more details.
...
- `"type":"even_node_count"­` - The code name identifier of this specific event. See [logged alerts and events](/content/operate/rs/7.4/clusters/logging/alerts-events.md) for more details.
...
- `"type":"even_node_count"` -­ The code name of this specific event. See [logged alerts and events](/content/operate/rs/7.4/clusters/logging/alerts-events.md) for more details.
...
- `"type":"insufficient_disk_aofrw"­` - The code name of this specific event. See [logged alerts and events](/content/operate/rs/7.4/clusters/logging/alerts-events.md) for more details.
