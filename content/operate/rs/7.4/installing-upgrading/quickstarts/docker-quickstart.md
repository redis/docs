...
- Port 9443 for [REST API](/content/operate/rs/7.4/references/rest-api/_index.md) connections

- Port 12000 configured Redis database port allowing client connections

You can publish other [ports](/content/operate/rs/7.4/networking/port-configurations.md)
...
Every installation of Redis Enterprise Software includes the command-line tool [`redis-cli`](/content/operate/rs/7.4/references/cli-utilities/redis-cli/_index.md) to interact with your Redis database. You can use `redis-cli` to connect to your database from within the same Docker network.
