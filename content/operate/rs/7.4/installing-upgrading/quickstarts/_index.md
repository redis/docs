...
- Set up a [Auto Tiering cluster](/content/operate/rs/7.4/databases/auto-tiering/quickstart.md) to optimize  memory resources.

- Set up an [Active-Active cluster](/content/operate/rs/7.4/databases/active-active/get-started.md) to enable high availability.

- [Benchmark](/content/operate/rs/7.4/clusters/optimize/memtier-benchmark.md) Redis Enterprise Software performance.
