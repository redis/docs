...
utilizes and manages memory, it is best to prevent OS swapping. For more details, see [memory limits](/content/operate/rs/7.4/databases/memory-performance/memory-limit.md). The
