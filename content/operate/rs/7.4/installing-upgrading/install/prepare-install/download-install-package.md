...
> review the [configuration requirements for AWS EC2 instances](/content/operate/rs/7.4/installing-upgrading/install/plan-deployment/configuring-aws-instances.md).
