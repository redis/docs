...
| /opt/redislabs/bin | Binaries for all the utilities for command-line access and management, such as [`rladmin`](/content/operate/rs/7.4/references/cli-utilities/rladmin/_index.md) or [`redis-cli`](/content/operate/rs/7.4/references/cli-utilities/redis-cli/_index.md) |
...
- [Ephemeral and persistence storage](/content/operate/rs/7.4/clusters/new-cluster-setup.md) during cluster setup
- [Socket files](/content/operate/rs/7.4/installing-upgrading/configuring/change-location-socket-files.md) after cluster setup
