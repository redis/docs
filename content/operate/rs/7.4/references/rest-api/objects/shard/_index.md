...
| backup | [backup](/content/operate/rs/7.4/references/rest-api/objects/shard/backup.md) object | Current status of scheduled periodic backup process |
...
| loading | [loading](/content/operate/rs/7.4/references/rest-api/objects/shard/loading.md) object | Current status of dump file loading |
...
| sync | [sync](/content/operate/rs/7.4/references/rest-api/objects/shard/sync.md) object | Shard's current sync status and progress |
