...
|------|------------|-------------|
| add_instances | array of [CRDB instance_info](/content/operate/rs/7.4/references/rest-api/objects/crdb/instance_info.md) objects | List of new CRDB instances |
| crdb | [CRDB](/content/operate/rs/7.4/references/rest-api/objects/crdb/_index.md) object | An object that represents an Active-Active database |
