...
| configurations | array of [health_report_configuration](/content/operate/rs/7.4/references/rest-api/objects/crdb/health_report/health_report_configuration.md) objects | Stored database configurations |
