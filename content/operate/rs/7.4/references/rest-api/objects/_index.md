...
Certain [REST API requests](/content/operate/rs/7.4/references/rest-api/requests/_index.md) require you to include specific objects in the request body. Many requests also return objects in the response body.
