...
The source file to import should be in the [RDB](/content/operate/rs/7.4/databases/configure/database-persistence.md) format. It can also be in a compressed (gz) RDB file.
