...
| Permission name |
|-----------------|
| [update_bdb_with_action](/content/operate/rs/7.4/references/rest-api/permissions.md#update_bdb_with_action) |
...
Returns the upgraded [BDB object](/content/operate/rs/7.4/references/rest-api/objects/bdb/_index.md).
