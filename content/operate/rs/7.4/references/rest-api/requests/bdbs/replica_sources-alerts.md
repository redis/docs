...
See [REST API alerts overview](/content/operate/rs/7.4/references/rest-api/objects/alert.md) for a description of the alert state object.
...
Returns an [alert state object](/content/operate/rs/7.4/references/rest-api/objects/alert.md).
