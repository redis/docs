...
|-----------------|-------|
| [reset_bdb_current_backup_status](/content/operate/rs/7.4/references/rest-api/permissions.md#reset_bdb_current_backup_status) | admin<br />cluster_member<br />db_member |
