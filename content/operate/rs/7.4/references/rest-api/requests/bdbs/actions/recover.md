...
|-----------------|-------|
| [view_bdb_recovery_plan](/content/operate/rs/7.4/references/rest-api/permissions.md#view_bdb_recovery_plan) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer |
...
Initiates [recovery for a database](/content/operate/rs/databases/recover.md) in a recoverable state where all the database's files are available after [cluster recovery](/content/operate/rs/7.4/clusters/cluster-recovery.md).

#### Required permissions

| Permission name | Roles |
|-----------------|-------|
| [start_bdb_recovery](/content/operate/rs/7.4/references/rest-api/permissions.md#start_bdb_recovery) | admin<br />cluster_member<br />db_member |
