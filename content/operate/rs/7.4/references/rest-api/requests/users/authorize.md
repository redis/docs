...
Include a [JWT authorize object](/content/operate/rs/7.4/references/rest-api/objects/jwt_authorize.md) with a valid username and password in the request body.
