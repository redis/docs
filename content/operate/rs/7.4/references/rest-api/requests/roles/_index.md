...
|-----------------|-------|
| [view_all_roles_info](/content/operate/rs/7.4/references/rest-api/permissions.md#view_all_roles_info) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer |
...
Returns a JSON array of [role objects](/content/operate/rs/7.4/references/rest-api/objects/role.md).
...
| Permission name | Roles |
|-----------------|-------|
| [view_role_info](/content/operate/rs/7.4/references/rest-api/permissions.md#view_role_info) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer |
...
Returns a [role object](/content/operate/rs/7.4/references/rest-api/objects/role.md).
...
| Permission name | Roles |
|-----------------|-------|
| [update_role](/content/operate/rs/7.4/references/rest-api/permissions.md#update_role) | admin |
...
Include a [role object](/content/operate/rs/7.4/references/rest-api/objects/role.md) with updated fields in the request body.

### Response {#put-response}

Returns a [role object](/content/operate/rs/7.4/references/rest-api/objects/role.md) with the updated fields.
...
| Permission name | Roles |
|-----------------|-------|
| [create_role](/content/operate/rs/7.4/references/rest-api/permissions.md#create_role) | admin |
...
Include a [role object](/content/operate/rs/7.4/references/rest-api/objects/role.md) in the request body.

### Response {#post-response}

Returns the newly created [role object](/content/operate/rs/7.4/references/rest-api/objects/role.md).
...
| Permission name | Roles |
|-----------------|-------|
| [delete_role](/content/operate/rs/7.4/references/rest-api/permissions.md#delete_role) | admin |
