...
| Permission name |
|-----------------|
| [test_ocsp_status](/content/operate/rs/7.4/references/rest-api/permissions.md#test_ocsp_status) |
...
Returns an [OCSP status object](/content/operate/rs/7.4/references/rest-api/objects/ocsp_status.md).
