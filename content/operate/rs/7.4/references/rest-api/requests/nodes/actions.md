...
|-----------------|-------|
| [view_status_of_all_node_actions](/content/operate/rs/7.4/references/rest-api/permissions.md#view_status_of_all_node_actions) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer |
...
Returns a list of [action objects](/content/operate/rs/7.4/references/rest-api/objects/action.md).
...
| Permission name | Roles |
|-----------------|-------|
| [view_status_of_node_action](/content/operate/rs/7.4/references/rest-api/permissions.md#view_status_of_node_action) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer |
...
Returns a JSON object that includes a list of [action objects](/content/operate/rs/7.4/references/rest-api/objects/action.md) for the specified node.
...
Returns an [action object](/content/operate/rs/7.4/references/rest-api/objects/action.md) for the specified node.
...
| Permission name | Roles |
|-----------------|-------|
| [start_node_action](/content/operate/rs/7.4/references/rest-api/permissions.md#start_node_action) | admin |
...
- `maintenance_on`: Creates a snapshot of the node, migrates shards to other nodes, and prepares the node for maintenance. See [maintenance mode](/content/operate/rs/7.4/clusters/maintenance-mode.md) for more information.
...
- `maintenance_off`: Restores node to its previous state before maintenance started. See [maintenance mode](/content/operate/rs/7.4/clusters/maintenance-mode.md) for more information.
...
| Permission name |
|-----------------|
| [cancel_node_action](/content/operate/rs/7.4/references/rest-api/permissions.md#cancel_node_action) |
