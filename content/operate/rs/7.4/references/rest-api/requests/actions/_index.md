...
Returns a JSON array of [action objects](/content/operate/rs/7.4/references/rest-api/objects/action.md) and an array of [state-machine objects](/content/operate/rs/7.4/references/rest-api/objects/state-machine.md).
