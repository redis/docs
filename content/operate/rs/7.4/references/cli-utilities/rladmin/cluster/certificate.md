...
To set a certificate for a specific service, use the corresponding certificate name. See the [certificates table](/content/operate/rs/7.4/security/certificates/_index.md) for the list of cluster certificates and their descriptions.
