...
-  Use the `rladmin` command-line utility to set the [data_internode_encryption](/content/operate/rs/7.4/references/cli-utilities/rladmin/tune.md#tune-db) setting for the database:
