...
To enable PEM encryption and encrypt private keys on the disk, use [`rladmin`](/content/operate/rs/7.4/references/cli-utilities/rladmin/_index.md) or the [REST API](/content/operate/rs/7.4/references/rest-api/_index.md).
...
To deactivate PEM encryption and decrypt private keys on the disk, use [`rladmin`](/content/operate/rs/7.4/references/cli-utilities/rladmin/_index.md) or the [REST API](/content/operate/rs/7.4/references/rest-api/_index.md).
