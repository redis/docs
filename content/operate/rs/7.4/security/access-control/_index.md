...
When you create a database, [default user access](/content/operate/rs/7.4/security/access-control/manage-users/default-user.md) is enabled automatically.

If you set up role-based access controls for your database and don't require compatibility with versions earlier than Redis 6, you can [deactivate the default user](/content/operate/rs/7.4/security/access-control/manage-users/default-user.md).

> [!WARNING]
> Before you [deactivate default user access](/content/operate/rs/7.4/security/access-control/manage-users/default-user.md#deactivate-default-user), make sure the role associated with the database is [assigned to a user](/content/operate/rs/7.4/security/access-control/create-users.md#assign-roles-to-users). Otherwise, the database will be inaccessible.
