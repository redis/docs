...
Redis Enterprise Software supports LDAP through a [role-based mechanism](/content/operate/rs/7.4/security/access-control/ldap/_index.md), first introduced in v6.0.20.
...
- Use the [REST API](/content/operate/rs/7.4/references/rest-api/_index.md) to connect using authorized LDAP credentials.
