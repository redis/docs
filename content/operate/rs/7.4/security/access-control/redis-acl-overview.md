...
1. [Upgrade all databases](/content/operate/rs/7.4/installing-upgrading/upgrading/upgrade-database.md) in the cluster to Redis version 6.2 or later.
...
- The following password configuration syntax is not supported: `'>', '<', '#!', 'resetpass'`
    ...
    - [`rladmin cluster reset_password`](/content/operate/rs/7.4/references/cli-utilities/rladmin/cluster/reset_password.md):
    
        ```sh
        rladmin cluster reset_password <user email>
        ```

    - REST API [`PUT /v1/users`](/content/operate/rs/7.4/references/rest-api/requests/users/_index.md#put-user) request and provide `password`
