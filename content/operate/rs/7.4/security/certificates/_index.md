...
|------------------|-------------|
| `api` | Encrypts [REST API](/content/operate/rs/7.4/references/rest-api/_index.md) requests and responses. |
...
| `metrics_exporter` | Sends Redis Enterprise metrics to external [monitoring tools](/content/operate/rs/7.4/clusters/monitoring/_index.md) over a secure connection. |
| `proxy` | Creates secure, encrypted connections between clients and databases. |
| `syncer` | For [Active-Active](/content/operate/rs/7.4/databases/active-active/_index.md) or [Replica Of](/content/operate/rs/7.4/databases/import-export/replica-of/_index.md) databases, encrypts data during the synchronization of participating clusters. |
