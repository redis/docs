...
You can also use the REST API.  To learn more, see [Update certificates](/content/operate/rs/7.4/security/certificates/updating-certificates.md#how-to-update-certificates).
...
4.  Upload the certificate to your cluster.
    ...
    You can use [`rladmin`](/content/operate/rs/7.4/references/cli-utilities/rladmin/cluster/certificate.md) to replace the existing certificates with new certificates:
