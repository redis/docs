...
---
All data is stored and managed exclusively in either RAM or RAM + flash Memory ([Auto Tiering](/content/operate/rs/7.4/databases/auto-tiering/_index.md)) and therefore, is at risk of being lost upon a process or server
...
You can configure persistence when you [create a database](/content/operate/rs/7.4/databases/create.md), or you can edit an existing database's configuration:
