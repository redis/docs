...
library](/content/operate/rs/7.4/databases/connect/supported-clients-browsers.md)
...
We recommend these clients that are tested for use with the [Discovery Service](/content/operate/rs/7.4/databases/durability-ha/discovery-service.md) that uses the Redis Sentinel API:
