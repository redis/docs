...
| Permission name |
|-----------------|
| [view_all_ldap_mappings_info](/content/operate/rs/8.0/references/rest-api/permissions.md#view_all_ldap_mappings_info) |
...
Returns a JSON array of [LDAP mapping objects](/content/operate/rs/8.0/references/rest-api/objects/ldap_mapping.md).
...
| Permission name |
|-----------------|
| [view_ldap_mapping_info](/content/operate/rs/8.0/references/rest-api/permissions.md#view_ldap_mapping_info) |
...
Returns an [LDAP mapping object](/content/operate/rs/8.0/references/rest-api/objects/ldap_mapping.md).
...
| Permission name |
|-----------------|
| [update_ldap_mapping](/content/operate/rs/8.0/references/rest-api/permissions.md#update_ldap_mapping) |
...
Include an [LDAP mapping object](/content/operate/rs/8.0/references/rest-api/objects/ldap_mapping.md) with updated fields in the request body.
...
| Permission name |
|-----------------|
| [create_ldap_mapping](/content/operate/rs/8.0/references/rest-api/permissions.md#create_ldap_mapping) |
...
Include an [LDAP mapping object](/content/operate/rs/8.0/references/rest-api/objects/ldap_mapping.md) in the request body.
...
| Permission name |
|-----------------|
| [delete_ldap_mapping](/content/operate/rs/8.0/references/rest-api/permissions.md#delete_ldap_mapping) |
