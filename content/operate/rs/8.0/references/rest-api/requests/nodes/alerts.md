...
| Permission name |
|-----------------|
| [view_all_nodes_alerts](/content/operate/rs/8.0/references/rest-api/permissions.md#view_all_nodes_alerts) |
...
Returns a hash of node UIDs and the [alert states](/content/operate/rs/8.0/references/rest-api/objects/alert.md) for each node.
...
| Permission name |
|-----------------|
| [view_node_alerts](/content/operate/rs/8.0/references/rest-api/permissions.md#view_node_alerts) |
...
Returns a hash of [alert objects](/content/operate/rs/8.0/references/rest-api/objects/alert.md) and their states for a specific node.
