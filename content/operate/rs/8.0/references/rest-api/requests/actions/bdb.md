...
Returns an array of JSON objects with attributes from [actions](/content/operate/rs/8.0/references/rest-api/objects/action.md) and [state machines](/content/operate/rs/8.0/references/rest-api/objects/state-machine.md).
