...
Use this action to resume read and write traffic on a database, where traffic was previously paused using the [`stop_traffic`](/content/operate/rs/8.0/references/rest-api/requests/bdbs/actions/stop_traffic.md) action.
