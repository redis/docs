...
The response body contains a JSON array with all shards, represented as [shard objects](/content/operate/rs/8.0/references/rest-api/objects/shard/_index.md).
