...
|-----------------|-------|
| [start_bdb_export](/content/operate/rs/8.0/references/rest-api/permissions.md#start_bdb_export) | admin<br />cluster_member<br />db_member |
