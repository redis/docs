...
Use this action to stop read and write traffic on a database. To resume traffic afterward, use the [`resume_traffic`](/content/operate/rs/8.0/references/rest-api/requests/bdbs/actions/resume_traffic.md) action.
