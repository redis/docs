...
|-----------------|-------|
| [view_cluster_stats](/content/operate/rs/8.0/references/rest-api/permissions.md#view_cluster_stats) | admin<br />cluster_member<br />cluster_viewer<br />db_member<br />db_viewer<br />user_manager |
...
Returns [statistics](/content/operate/rs/8.0/references/rest-api/objects/statistics/_index.md) for the cluster.
