...
See the [certificates table](/content/operate/rs/8.0/security/certificates/_index.md) for the list of cluster certificates and their descriptions.
...
Include an array of [certificate objects](/content/operate/rs/8.0/references/rest-api/objects/certificates.md) in the request body.
...
this endpoint. See the [certificates table](/content/operate/rs/8.0/security/certificates/_index.md) for the list of cluster certificates and their descriptions.
