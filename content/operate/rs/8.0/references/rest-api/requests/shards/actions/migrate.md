...
For more information about shard migration use cases and considerations, see [Migrate database shards](/content/operate/rs/8.0/databases/migrate-shards.md).

#### Required permissions

| Permission name | Roles |
|-----------------|-------|
| [migrate_shard](/content/operate/rs/8.0/references/rest-api/permissions.md#migrate_shard) | admin<br />cluster_member<br />db_member |
...
Returns a JSON object with an `action_uid`. You can track the action's progress with a [`GET /v1/actions/<action_uid>`](/content/operate/rs/8.0/references/rest-api/requests/actions/_index.md#get-action) request.
