...
Returns most recent [statistics](/content/operate/rs/8.0/references/rest-api/objects/statistics/_index.md) for all shards.
...
Returns the most recent [statistics](/content/operate/rs/8.0/references/rest-api/objects/statistics/_index.md) for the specified shard.
