...
The request must contain a [bootstrap configuration object](/content/operate/rs/8.0/references/rest-api/objects/bootstrap/_index.md), similar to the one used for actual bootstrapping.
