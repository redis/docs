...
|------|------------|-------------|
| name | "cm"<br />"api"<br />"mtls_trusted_ca"<br />"proxy"<br />"metrics_exporter"<br />"syncer"<br />"ldap_client"<br />"ccs_internode_encryption"<br />"data_internode_encryption"<br />"sso_service"<br />"sso_issuer" | Certificate type.<br />See the [certificates table](/content/operate/rs/8.0/security/certificates/_index.md) for the list of cluster certificates and their descriptions. |
