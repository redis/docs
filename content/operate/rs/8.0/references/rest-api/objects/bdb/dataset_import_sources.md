...
The source file to import should be in the [RDB](/content/operate/rs/8.0/databases/configure/database-persistence.md) format. It can also be in a compressed (gz) RDB file.
