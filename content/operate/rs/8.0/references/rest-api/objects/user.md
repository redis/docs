...
| role | 'admin'<br />'cluster_member'<br />'cluster_viewer'<br />'db_member'<br /> **'db_viewer'** <br />'user_manager'<br />'none' | User's [role](/content/operate/rs/8.0/references/rest-api/permissions.md#roles) |
