...
Use [`rladmin status shards`](/content/operate/rs/8.0/references/cli-utilities/rladmin/status.md#status-shards) to verify that the roles were changed.
...
Use [`rladmin status endpoints`](/content/operate/rs/8.0/references/cli-utilities/rladmin/status.md#status-endpoints) to verify that the roles were changed.
