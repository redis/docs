...
Once this command finishes, the other replicas must remove this instance with [`crdb-cli crdb remove-instance --force`](/content/operate/rs/8.0/references/cli-utilities/crdb-cli/crdb/remove-instance.md).
