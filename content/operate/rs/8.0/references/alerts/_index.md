...
1. In **Cluster > Alert Settings**, click **Edit**.
1. Select **Set an email** to configure the [email server settings](/content/operate/rs/8.0/clusters/configure/cluster-settings.md#configure-email-server-settings).
1. In **Configuration** for the database, click **Edit**.
1. Select the **Alerts** section to open it.
