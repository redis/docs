...
Flex is compatible with the Redis API and supports all [Redis data types](/content/develop/data-types/_index.md), including JSON and probabilistic data structures (Bloom filters, Count-Min Sketch, Top-K).
...
- [Active-Active](/content/operate/rs/8.0/databases/active-active/_index.md)
...
- [Plan your deployment](/content/operate/rs/8.0/flex/plan.md): Review hardware requirements, sizing guidelines, and limitations.
- [Get started](/content/operate/rs/8.0/flex/get-started.md): Configure Flex on your cluster.
- [Scale your deployment](/content/operate/rs/8.0/flex/scale.md): Learn scaling strategies and best practices.
