...
keys](/content/operate/rs/8.0/clusters/configure/license-keys.md).
...
You can also configure email server settings and [send alerts by email](/content/operate/rs/8.0/monitoring/v1_monitoring.md#send-alerts-by-email) to relevant users.
