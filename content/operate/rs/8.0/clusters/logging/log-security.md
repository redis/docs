...
---
Redis Software comes with [a set of logs](/content/operate/rs/8.0/clusters/logging/_index.md) on the server and available through the user interface to assist users in investigating actions taken on the server and to troubleshoot issues.
