...
During Redis Software installation, the [installer prompts](/content/operate/rs/8.0/installing-upgrading/install/manage-installation-questions.md) you to confirm auto-configuration of a default (public) zone
...
> [!NOTE]
> If databases are created with non-standard [Redis Software ports](/content/operate/rs/8.0/networking/port-configurations.md),
