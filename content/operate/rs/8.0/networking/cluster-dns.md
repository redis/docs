...
When using the IP-based connection method, you can use the [Discovery Service](/content/operate/rs/8.0/databases/durability-ha/discovery-service.md)
...
To test your connection, try pinging the service.  For help, see [Connect to your database](/content/operate/rs/8.0/databases/connect/test-client-connectivity.md).
