...
You can [use TLS authentication](/content/operate/rs/8.0/security/encryption/tls/enable-tls.md) for the following types of communication:
...
You can change the [TLS protocols](/content/operate/rs/8.0/security/encryption/tls/tls-protocols.md) and [ciphers](/content/operate/rs/8.0/security/encryption/tls/ciphers.md) to improve the security of your Redis Software cluster and databases. The default settings are in line with industry best practices, but you can customize them to match the security policy of your organization.
