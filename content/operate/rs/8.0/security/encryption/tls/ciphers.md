...
| sentinel_cipher_suites | <span title="Yes">&#x2705; Yes</span> | Cipher list for [discovery service](/content/operate/rs/8.0/databases/durability-ha/discovery-service.md) (Sentinel) TLS 1.2 communications |
...
| sentinel_cipher_suites_tls_1_3 | <span title="No">&#x274c; No</span> | Cipher list for [discovery service](/content/operate/rs/8.0/databases/durability-ha/discovery-service.md) (Sentinel) TLS 1.3 communications |

## Configure cipher suites

You can configure ciphers with the [Cluster Manager UI](#edit-ciphers-ui), [`rladmin`](/content/operate/rs/8.0/references/cli-utilities/rladmin/cluster/config.md), or the [REST API](/content/operate/rs/8.0/references/rest-api/requests/cluster/_index.md#put-cluster).
...
To configure TLS 1.2 cipher suites for cluster communication, use the following [`rladmin`](/content/operate/rs/8.0/references/cli-utilities/rladmin/_index.md) command syntax:
...
To configure TLS 1.2 cipher suites for communications between applications and databases, use the following [`rladmin`](/content/operate/rs/8.0/references/cli-utilities/rladmin/_index.md) command syntax:
...
To configure TLS 1.3 cipher suites for communications between applications and databases, use the following [`rladmin`](/content/operate/rs/8.0/references/cli-utilities/rladmin/_index.md) command syntax:
...
Sentinel service cipher suites use the golang.org OpenSSL format for [discovery service](/content/operate/rs/8.0/databases/durability-ha/discovery-service.md) TLS connections in Redis Software version 6.0.20 or later. See their documentation for a list of [available configurations](https://golang.org/src/crypto/tls/cipher_suites.go).

#### Configure TLS 1.2 discovery service cipher suites

To configure TLS 1.2 cipher suites for the discovery service cipher suites, use the following [`rladmin`](/content/operate/rs/8.0/references/cli-utilities/rladmin/_index.md) command syntax:
