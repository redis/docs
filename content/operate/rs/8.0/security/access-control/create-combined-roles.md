...
1. Define the ACL rule. For more information about Redis ACL rules and syntax, see the [Redis ACL overview](/content/operate/rs/8.0/security/access-control/redis-acl-overview.md).

1. Click **Save**.

-tab-sep-

To define a Redis ACL rule using the REST API, use a [create Redis ACL](/content/operate/rs/8.0/references/rest-api/requests/redis_acls/_index.md#post-redis_acl) request. For more information about Redis ACL rules and syntax, see the [Redis ACL overview](/content/operate/rs/8.0/security/access-control/redis-acl-overview.md).
...
1. Choose a **Management role** other than **None**. For details about permissions granted by each role, see [Cluster Manager UI permissions](/content/operate/rs/8.0/security/access-control/create-cluster-roles.md#cluster-manager-ui-permissions) and [REST API permissions](/content/operate/rs/8.0/references/rest-api/permissions.md).
...
1. Use a [create role](/content/operate/rs/8.0/references/rest-api/requests/roles/_index.md#post-role) request:
...
2. [Update a database's configuration](/content/operate/rs/8.0/references/rest-api/requests/bdbs/_index.md#put-bdbs) to add `roles_permissions` with the role and Redis ACL:
...
You can [assign the new role to users](/content/operate/rs/8.0/security/access-control/create-users.md#assign-roles-to-users) to grant database access and access to the Cluster Manager UI and REST API.
