...
Redis Software supports LDAP through a [role-based mechanism](/content/operate/rs/8.0/security/access-control/ldap/_index.md), first introduced [in v6.0.20](/content/operate/rs/release-notes/rs-6-0-20-april-2021.md).
...
- Use the [REST API](/content/operate/rs/8.0/references/rest-api/_index.md) to connect using authorized LDAP credentials.
