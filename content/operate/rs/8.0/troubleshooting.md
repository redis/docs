...
- [Create a support package](/content/operate/rs/8.0/installing-upgrading/creating-support-package.md) to gather information about the cluster, nodes, and databases to help debug issues

- [Logging](/content/operate/rs/8.0/clusters/logging/_index.md)

- [`rladmin status`](/content/operate/rs/8.0/references/cli-utilities/rladmin/status.md) command, which displays the current status of nodes, databases, database endpoints, and shards on the cluster

- [`rlcheck`](/content/operate/rs/8.0/references/cli-utilities/rlcheck/_index.md)  utility, which runs various tests to check node health and reports any discovered issues

- [Troubleshooting pocket guide](/content/operate/rs/8.0/databases/connect/troubleshooting-guide.md)

## Troubleshooting by topic

For troubleshooting specific issues, see:

- [Database connectivity troubleshooting](/content/operate/rs/8.0/databases/connect/troubleshooting-guide.md#troubleshoot-connectivity)

- [Latency troubleshooting](/content/operate/rs/8.0/databases/connect/troubleshooting-guide.md#troubleshoot-latency)

- [Replica Of repeatedly fails](/content/operate/rs/8.0/databases/import-export/replica-of/replicaof-repeatedly-fails.md)

- CRDT [INFO](/content/operate/rs/8.0/databases/active-active/develop/develop-for-aa.md#info) for troubleshooting Active-Active databases
