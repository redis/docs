...
1. In **Access Control**, select the [database and cluster alerts]({{< relref "/operate/rs/8.0/security/access-control/create-users#add-users" >}}) that you want each user to receive.
