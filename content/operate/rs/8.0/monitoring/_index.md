...
See [Metrics and alerts for monitoring v1](/content/operate/rs/8.0/monitoring/v1_monitoring.md) for more information.
...
See [Metrics stream engine for monitoring v2](/content/operate/rs/8.0/monitoring/metrics_stream_engine/_index.md) for more information.
...
Make sure you read the [definition of each metric](/content/operate/rs/8.0/references/metrics/_index.md)
