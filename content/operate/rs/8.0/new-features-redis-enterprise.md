...
Active-Active databases](/content/operate/rs/8.0/developing/crdbs).
...
on Docker.](/content/operate/rs/8.0/installing-upgrading/get-started-docker.md)
...
Integration](/content/operate/rs/8.0/security/passwords-users-roles.md#setting-up-ldap).
