...
The default policy for [Active-Active databases](/content/operate/rs/8.0/databases/active-active/_index.md) is _noeviction_ policy.
...
For larger databases, consider using [Redis Flex or Auto Tiering ](/content/operate/rs/8.0/databases/flash/_index.md).
