...
When you enable [database replication](/content/operate/rs/8.0/databases/durability-ha/replication.md),
...
1. Meets replica migration requirements, such as [rack-awareness](/content/operate/rs/8.0/clusters/configure/rack-zone-awareness.md).
...
> [!NOTE]
> - Replica HA follows all prerequisites of replica migration, such as [rack-awareness](/content/operate/rs/8.0/clusters/configure/rack-zone-awareness.md).
...
To configure cooldown periods, use [`rladmin tune cluster`](/content/operate/rs/8.0/references/cli-utilities/rladmin/tune.md#tune-cluster):
