...
You can configure persistence when you [create a database](/content/operate/rs/8.0/databases/create.md), or you can edit an existing database's configuration:
