...
- [Network-based](/content/operate/rs/8.0/databases/active-active/disaster-recovery/network-based.md): Global traffic managers and load balancers handle routing at the network layer, requiring no application changes.

- [Proxy-based](/content/operate/rs/8.0/databases/active-active/disaster-recovery/proxy-based.md): Software proxies handle detection and routing logic.

- [Client library-based](/content/operate/rs/8.0/databases/active-active/disaster-recovery/client-library-based.md): Redis client libraries with built-in failover logic.

- [Application-based](/content/operate/rs/8.0/databases/active-active/disaster-recovery/application-based.md): Custom application-level monitoring and connectivity management.
...
- Does the Active-Active database use DNS, the [OSS Cluster API](/content/operate/rs/8.0/clusters/optimize/oss-cluster-api.md), or the [discovery service](/content/operate/rs/8.0/databases/durability-ha/discovery-service.md)?
...
See [Lag-aware database availability requests](/content/operate/rs/8.0/monitoring/db-availability.md#lag-aware) for more information.
