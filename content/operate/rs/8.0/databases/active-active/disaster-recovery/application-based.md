...
For more information, see [Application failover with Active-Active databases](/content/operate/rs/8.0/databases/active-active/develop/app-failover-active-active.md).
