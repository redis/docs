...
If you have data in a single-region Redis Software database that you want to migrate to an [Active-Active database](/content/operate/rs/8.0/databases/active-active/_index.md),
you'll need to create a new Active-Active database and migrate the data into the new database as a [Replica Of](/content/operate/rs/8.0/databases/import-export/replica-of/_index.md) the existing database.
...
the [client mDNS prerequisites](/content/operate/rs/8.0/networking/mdns.md) must be met in order to communicate with other clusters.
...
1. Create a new Active-Active database. For prerequisites and detailed instructions, see [Create an Active-Active geo-replicated database](/content/operate/rs/8.0/databases/active-active/create.md).
...
> you can [compress the replication data](/content/operate/rs/8.0/databases/import-export/replica-of/_index.md#data-compression-for-replica-of) to save bandwidth.
