...
This release introduces the ability to [index, query, and full-text search JSON documents](/content/develop/ai/search-and-query/indexing/_index.md) using JSONPath queries.
