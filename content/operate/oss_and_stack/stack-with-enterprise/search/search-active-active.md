...
1. [Create the index](/content/commands/ft.create.md) on each instance of the database.
1. If you are using [synonyms](/content/develop/ai/search-and-query/advanced-concepts/synonyms.md), you need to add them to each replica.
