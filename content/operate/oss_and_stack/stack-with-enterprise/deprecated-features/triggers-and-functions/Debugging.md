...
1. Use Redis [pub/sub](/content/develop/pubsub/_index.md).
...
If you don't have access to your Redis database log files, you can use pub/sub. The following example demonstrates how to use the [client.call](/content/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/concepts/JavaScript_API.md#clientcall) API to publish to a pub/sub channel.
