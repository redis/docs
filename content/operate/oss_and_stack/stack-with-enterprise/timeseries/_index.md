...
Redis does this indexing for you based on `field value` pairs called [labels]({{< relref "/integrate/redisvl/user-guide/get-started" >}}timeseries/quickstart/#labels). You can add labels to each time series and use them to [filter]({{< relref "/integrate/redisvl/user-guide/get-started" >}}timeseries/quickstart/#filtering) at query time.
...
Here's an example of [aggregation]({{< relref "/integrate/redisvl/user-guide/get-started" >}}timeseries/quickstart/#aggregation) over time buckets of 5,000 milliseconds:  
