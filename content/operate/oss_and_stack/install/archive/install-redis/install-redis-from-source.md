...
For a more complete installation, continue with [these instructions](/content/operate/oss_and_stack/install/archive/install-redis/_index.md#install-redis-properly).
