...
title: Build and run Redis Community Edition 8 on Ubuntu 24.04 (Noble)
weight: 35
---

Follow the steps below to build and run Redis Community Edition 8 from its source code on a system running Ubuntu 24.04 (Noble).
