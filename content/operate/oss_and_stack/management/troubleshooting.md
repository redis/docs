...
* If you have **latency problems** with Redis, that in some way appears to be idle for some time, read our [Redis latency troubleshooting guide](/content/operate/oss_and_stack/management/optimization/latency.md).
* Redis stable releases are usually very reliable, however in the rare event you are **experiencing crashes** the developers can help a lot more if you provide debugging information. Please read our [Debugging Redis guide](/content/operate/oss_and_stack/management/debugging.md).
...
* Certain versions of the Xen hypervisor report poor fork() performance. See [the latency page](/content/operate/oss_and_stack/management/optimization/latency.md) for more information.
