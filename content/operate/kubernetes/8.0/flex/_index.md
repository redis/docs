...
Flex replaces [Auto Tiering]({{< relref "/operate/kubernetes/8.0/7.22/re-clusters/auto-tiering" >}}) (formerly known as Redis on Flash). Redis Enterprise selects the implementation based on your database version:
...
For Redis Enterprise for Kubernetes version 7.22.2-22 or earlier, see [Auto Tiering]({{< relref "/operate/kubernetes/8.0/7.22/re-clusters/auto-tiering" >}}).
