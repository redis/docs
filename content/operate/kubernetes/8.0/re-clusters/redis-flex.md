...
weight: 16
url: '/operate/kubernetes/8.0/re-clusters/redis-flex/'
---
...
{{<warning>}}
Redis Flex is not supported for [Active-Active databases]({{< relref "/operate/kubernetes/8.0/active-active" >}}).
{{</warning>}}
...
To deploy a Redis Enterprise cluster (REC) with Redis Flex, specify the following fields in the `redisOnFlashSpec` section of your [REC custom resource]({{< relref "/operate/kubernetes/8.0/reference/api/redis_enterprise_cluster_api#specredisonflashspec" >}}):
