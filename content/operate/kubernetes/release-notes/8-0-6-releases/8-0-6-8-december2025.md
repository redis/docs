...
Redis Enterprise for Kubernetes 8.0.6-8 is a feature release that supports Redis Software [8.0.6-54](/content/operate/rs/release-notes/rs-8-0-releases/rs-8-0-6-54.md), and includes enhancements, supported distribution updates and bug fixes.

## Highlights

- Support for external module repositories (custom modules)
- Support for Redis Software [8.0.6-54](/content/operate/rs/release-notes/rs-8-0-releases/rs-8-0-6-54.md)
...
- Redis Software [8.0.6-54](/content/operate/rs/release-notes/rs-8-0-releases/rs-8-0-6-54.md) <!--RED-172935-->
- User-defined certificates for [internode encryption](/content/operate/kubernetes/security/certificates/internode-encryption.md) <!--RED-173229-->
