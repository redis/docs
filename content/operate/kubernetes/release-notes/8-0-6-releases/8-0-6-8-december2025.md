...
Redis Enterprise for Kuberntes 8.0.6-8 is a feature release that supports Redis Software 8.0.6-54, and includes enhancements, supported distribution updates and bug fixes.
