...
- operate
- kubernetes
description: Feature release with OSS Cluster API support for external clients, ARM architecture support, and Redis Software 8.0.10-43.
hideListLinks: true
linkTitle: 8.0.10-19 (February 2026)
title: Redis Enterprise for Kubernetes 8.0.10-19 (February 2026) release notes
weight: 31
---

Redis Enterprise for Kubernetes 8.0.10-19 is a feature release that supports Redis Software 8.0.10-43 and includes new features and enhancements.

## Highlights

- OSS Cluster API support for external clients
- ARM architecture support
- Redis Software 8.0.10-43 support
...
|---|---|---|---|
| REAADB | `spec.redisEnterpriseCluster.ossClusterSettings` | Added | Configures OSS cluster behavior. |
| REAADB | `spec.redisEnterpriseCluster.ossClusterSettings.enableExternalAccess` | Added | Enables external access for OSS cluster mode. |
| REDB | `spec.ossClusterSettings` | Added | Configures OSS cluster mode settings. |
| REDB | `spec.ossClusterSettings.enableExternalAccess` | Added | Enables external access in OSS cluster mode. When enabled, the advertised database topology includes external endpoints for the Redis Enterprise nodes hosting the database shards. Configure the external access mechanism (such as LoadBalancer services) using the `ossClusterSettings.externalAccessType` field of the RedisEnterpriseCluster. When you enable external access, the database secret includes the list of primary shard IPs in the `oss_startup_nodes` field. |
...
- **Redis Enterprise**: `redislabs/redis:8.0.10-43`
- **Operator**: `redislabs/operator:8.0.10-19`
- **Services Rigger**: `redislabs/k8s-controller:8.0.10-19`
- **Callhome client**: `redislabs/re-call-home-client:8.0.10-19`
- **Redis Enterprise operator bundle**: `8.0.10-19.2`
...
- **Upgrades from versions earlier than 7.4.2-2 are not supported.** If you use an earlier version, upgrade to 7.4.2-2 before upgrading to 8.0.10-19.
