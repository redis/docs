...
- operate
- kubernetes
description: Feature release with OSS Cluster API support for external clients, ARM architecture support, and Redis Software 8.0.10-50.
hideListLinks: true
...
Redis Enterprise for Kubernetes 8.0.10-19 is a feature release that supports Redis Software 8.0.10-50 and includes new features and enhancements.

## Highlights

- OSS Cluster API support for external clients
- ARM architecture support
- Redis Software 8.0.10-50 support
...
- **Redis Enterprise**: `redislabs/redis:8.0.10-50`
