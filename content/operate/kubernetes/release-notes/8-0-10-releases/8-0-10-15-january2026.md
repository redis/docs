...
hideListLinks: true
linkTitle: 8.0.10-15 (January 2026)
title: Redis Enterprise for Kubernetes 8.0.10-15 (January 2026) release notes
weight: 1
---

Redis Enterprise for Kubernetes 8.0.10-15 is a feature release that supports Redis Software 8.0.10-43 and includes new features and enhancements.
...
- **Operator**: `redislabs/operator:8.0.10-15`
- **Services Rigger**: `redislabs/k8s-controller:8.0.10-15`
- **Callhome client**: `redislabs/re-call-home-client:8.0.10-15`
- **Redis Enterprise operator bundle**: `8.0.10-15.2`
...
- **Upgrades from versions earlier than 7.4.2-2 are not supported.** If you use an earlier version, upgrade to 7.4.2-2 before upgrading to 8.0.10-15.
