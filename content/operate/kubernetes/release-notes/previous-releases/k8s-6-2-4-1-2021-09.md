...
The Redis Enterprise [K8s 6.2.4-1](https://github.com/RedisLabs/redis-enterprise-k8s-docs/releases/tag/v6.2.4-1) release provides support for the [Redis Enterprise Software release 6.2.4](/content/operate/rs/release-notes/rs-6-2-4-august-2021.md) and includes several enhancements and bug fixes.
