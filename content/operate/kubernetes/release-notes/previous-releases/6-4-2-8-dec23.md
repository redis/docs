...
See [6.4.2-8 (July 2023) release notes](/content/operate/kubernetes/release-notes/previous-releases/6-4-2-8.md#compatibility).
...
See [6.4.2-8 (July 2023) release notes](/content/operate/kubernetes/release-notes/previous-releases/6-4-2-8.md#known-limitations).

## Security

For a list of fixes related to CVEs, see the [Redis Enterprise 6.4.2-103 release notes](/content/operate/rs/release-notes/rs-6-4-2-releases/rs-6-4-2-103.md).