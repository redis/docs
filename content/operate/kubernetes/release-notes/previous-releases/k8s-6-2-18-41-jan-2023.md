...
New images and fixes are listed below. Refer to [6.2.18-41 (Dec 2022](/content/operate/kubernetes/release-notes/previous-releases/k8s-6-2-18-41.md) for compatibility notes and known limitations.
...
See [Redis Enterprise for Kubernetes release notes 6.2.18-41 (Dec 2022)](/content/operate/kubernetes/release-notes/previous-releases/k8s-6-2-18-41.md).
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.2.18-72 release notes](/content/operate/rs/release-notes/rs-6-2-18-releases/rs-6-2-18-70.md#security).
