...
* Following old revision of quick start guide causes issues creating an REDB due to unrecognized memory field name (RED-69515)
  ...
  The workaround is to use the newer (current) revision of the [quick start document](/content/operate/kubernetes/deployment/quick-start.md) available online.
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.2.18-65 release notes](/content/operate/rs/release-notes/rs-6-2-18-releases/rs-6-2-18-65.md#security).
