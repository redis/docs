...
For a list of fixes related to CVEs, see the [Redis Enterprise 7.4.6-22 release notes](/content/operate/rs/release-notes/rs-7-4-2-releases/_index.md).
...
The limitations below are specific to the Redis Enterprise for Kubernetes product. To view limitations for the supported Redis Enterprise Software version, see the [7.4.2 release notes](/content/operate/rs/release-notes/rs-7-4-2-releases/_index.md#known-limitations).
