...
- Updated [supported distributions](/content/operate/kubernetes/release-notes/7-4-2-releases/_index.md#supported-distributions) (RED-119711)
...
For a list of fixes related to CVEs, see the [Redis Enterprise 7.4.2-129 release notes](/content/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-2-129.md#security).
