...
The primary purpose of this release is to support [Redis Enterprise 7.4.2](/content/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-2-104.md), which is a maintenance release of Redis Enterprise Software.

## Version changes

For a list of fixes related to CVEs, see the [Redis Enterprise 7.4.2-104 release notes](/content/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-2-104.md#security).
...
See the [7.4.2 releases](/content/operate/kubernetes/release-notes/7-4-2-releases/_index.md) page for the list of supported distributions.
...
See the [7.4.2 releases](/content/operate/kubernetes/release-notes/7-4-2-releases/_index.md) page for the list of known limitations.
