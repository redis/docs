...
This maintenance release of Redis Enterprise for Kubernetes supports Redis Software 8.0.6-54 and includes enhancements, API changes, and bug fixes.
...
- Support for Redis Enterprise Software version 8.0.6-54
...
For additional breaking changes related to Redis Software 8.0.6-54, see [Redis 8 breaking changes]({{< relref "/operate/rs/release-notes/rs-8-0-releases/rs-8-0-2-17#redis-8-breaking-changes" >}}).
