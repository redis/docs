...
This release includes bug fixes, enhancements, and support for [Redis Enterprise Software version 7.8.4-66](/content/operate/rs/release-notes/rs-7-8-releases/rs-7-8-4-66.md).
...
- Support for [Redis Enterprise Software version 7.8.4-66](/content/operate/rs/release-notes/rs-7-8-releases/rs-7-8-4-66.md).
