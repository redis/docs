...
Redis Software for Kubernetes 7.8.6-20 (September 2026) is a maintenance release that includes support for [Redis Software 7.8.6-315](/content/operate/rs/release-notes/rs-7-8-releases/_index.md). It fixes a high-severity bug with security implications that affected Active-Active databases.

For supported distributions, known limitations, and API changes, see [Redis Software for Kubernetes 7.8.6-1 March 2025 release notes](/content/operate/kubernetes/release-notes/7-8-6-releases/7-8-6-1-march2025.md).
