...
Redis Enterprise for Kubernetes 7.8.6-1 is a feature release that includes enhancements, bug fixes, platform updates, and support for Redis Software 7.8.6-13. This release also includes the ability to [install the operator using Helm]({{<relref "deployment/helm.md">}}).
