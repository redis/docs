...
Redis Enterprise for Kubernetes 7.8.6-1 is a feature release that includes enhancements, bug fixes, platform updates, and support for [Redis Software 7.8.6-13](/content/operate/rs/release-notes/rs-7-8-releases/rs-7-8-6-13.md).

This release also includes the ability to [install the operator using Helm](/content/operate/kubernetes/deployment/helm.md).
...
- Added support for [Redis Software 7.8.6-13](/content/operate/rs/release-notes/rs-7-8-releases/rs-7-8-6-13.md).
