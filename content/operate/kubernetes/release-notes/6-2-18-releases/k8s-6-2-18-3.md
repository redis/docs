...
{{<warning>}}
If you use NGINX as an ingress controller for Redis Enterprise, **do not upgrade** to the 6.2.18-3 release. Skip this release and upgrade to version [6.2.18-41]({{< relref "/operate/kubernetes/release-notes/6-2-18-releases/" >}}) instead.
{{</warning>}}
