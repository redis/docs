...
* Support for [Redis Flex]({{< relref "/operate/kubernetes/re-clusters/redis-flex.md" >}}) (RED-78613)
...
* `.isRoF` and `.rofRamSize` added to support the [Redis Flex feature]({{< relref "/operate/kubernetes/re-clusters/redis-flex.md" >}}).
