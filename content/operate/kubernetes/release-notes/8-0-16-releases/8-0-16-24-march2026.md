...
- Fixed an issue where an expired license caused the REC pod readiness probe to fail after restart <!--RED-185977-->
...
- **Redis Enterprise operator bundle**: `8.0.16-24.4`
