...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.4.2-94 release notes]({{<relref "operate/rs/release-notes/rs-6-4-2-releases/rs-6-4-2-94/#security">}}).