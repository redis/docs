...
description: This is a feature release with a new version of Redis Enterprise Software
  7.4.2.
linkTitle: 7.4.6-1 (July 2024)
title: Redis Enterprise for Kubernetes 7.4.6-1 (July 2024) release notes
weight: 4
---

## Highlights

The primary purpose of this release is to support the latest version of Redis Enterprise Software. It also includes updates to supported platform distributions.
...
- Support for Redis Enterprise 7.4.6-14 (RED-13110)
...
| **Rancher RKE2** | <span title="Deprecation warning" class="font-serif">:warning:</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |  |  |  |
...
- **Redis Enterprise**: `redislabs/redis:7.4.6-14`
- **Operator**: `redislabs/operator:7.4.6-1`
- **Services Rigger**: `redislabs/k8s-controller:7.4.6-1`

### OpenShift images

- **Redis Enterprise**: `registry.connect.redhat.com/redislabs/redis-enterprise:7.4.6-14.rhel8-openshift`
- **Operator**: `registry.connect.redhat.com/redislabs/redis-enterprise-operator:7.4.6-1`
- **Services Rigger**: `registry.connect.redhat.com/redislabs/services-manager:7.4.6-1`

### OLM bundle

**Redis Enterprise operator bundle** : `v7.4.6-1.0`
