...
This is a maintenance release of Redis Software for Kubernetes to support Redis Software version 7.22.2-189. It fixes a high-severity bug with security implications that affected Active-Active databases. For supported distributions and known limitations, see the [7.22.2 releases](/content/operate/kubernetes/release-notes/7-22-2-releases/_index.md).
...
See [7.22.2 releases](/content/operate/kubernetes/release-notes/7-22-2-releases/_index.md) for information on known limitations.
