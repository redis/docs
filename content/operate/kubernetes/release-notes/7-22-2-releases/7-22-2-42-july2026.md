...
This is a maintenance release of Redis for Kubernetes to support Redis Software version 7.22.2-170. For supported distributions and known limitations, see the [7.22.2 releases](/content/operate/kubernetes/release-notes/7-22-2-releases/_index.md).
