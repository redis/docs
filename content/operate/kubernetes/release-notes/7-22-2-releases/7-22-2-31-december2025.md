...
This is a maintenance release to support [Redis Enterprise Software version 7.22.2-41](/content/operate/rs/release-notes/rs-7-22-releases/rs-7-22-2-41.md). For supported distributions known limitations, see the [7.22.2 releases](/content/operate/kubernetes/release-notes/7-22-2-releases/_index.md).
...
For all other known limitations, see [7.22.2 releases](/content/operate/kubernetes/release-notes/7-22-2-releases/_index.md). 
