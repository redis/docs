...
This is a maintenance release to support Redis Enterprise Software version 7.22.2-55. For supported distributions and known limitations, see the [7.22.2 releases](/content/operate/kubernetes/release-notes/7-22-2-releases/_index.md).
