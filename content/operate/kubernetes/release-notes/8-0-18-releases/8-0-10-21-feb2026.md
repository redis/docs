...
hideListLinks: true
linkTitle: 8.0.18-8 (April 2026)
title: Redis Enterprise for Kubernetes 8.0.18-8 (April 2026) release notes
weight: 31
---

Redis Enterprise for Kubernetes 8.0.18-8 is a feature release that supports [Redis Software 8.0.18-23
...
| Kubernetes | **Redis <nobr>8.0.18-8</nobr>** |
|---|---|
| 1.35 | Supported |
| 1.34 | Supported |
| 1.33 | Deprecated |
...
- **Operator**: `redislabs/operator:8.0.18-8`
- **Services Rigger**: `redislabs/k8s-controller:8.0.18-8`
- **Callhome client**: `redislabs/re-call-home-client:8.0.18-8`

### Openshift downloads

- **Redis Enterprise OLM operator bundle**: `8.0.18-8.0`
- **Call Home Client**: `redislabs/call-home-client:8.0.18-8`
