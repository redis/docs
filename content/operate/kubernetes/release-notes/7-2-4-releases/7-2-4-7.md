...
For a list of fixes related to CVEs, see the [Redis Enterprise 7.2.4-64 release notes](/content/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-64.md#security).
