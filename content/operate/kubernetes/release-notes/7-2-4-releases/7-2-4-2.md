...
- Changes to [supported Kubernetes distributions](#supported-distributions)

## New in this release

### Enhancements

- Support for [Redis Enterprise 7.2.4](/content/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-52.md) (RED-73681)
...
For a list of fixes related to CVEs, see the [Redis Enterprise 7.2.4-52 release notes](/content/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-52.md#security).
