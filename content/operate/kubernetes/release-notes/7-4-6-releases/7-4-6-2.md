...
The primary purpose of this release is to support [Redis Enterprise Software version 7.4.6](/content/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-6-22.md). It also includes updates to supported platform distributions.
...
For a list of fixes related to CVEs, see the [Redis Enterprise 7.2.4-109 release notes](/content/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-6-22.md).
