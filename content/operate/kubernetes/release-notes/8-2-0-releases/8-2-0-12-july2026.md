...
Redis Software for Kubernetes 8.2.0-12 is a feature release that supports [Redis Software 8.2.0](/content/operate/rs/release-notes/rs-8-2-releases/_index.md) and includes new features, bug fixes, and enhancements.
...
This release adds the RBAC custom resource definitions and new fields for access control, metrics, auditing, and FIPS compliance. The table below summarizes the notable changes. For the complete field-level reference, see the [API reference](/content/operate/kubernetes/reference/api/_index.md).
