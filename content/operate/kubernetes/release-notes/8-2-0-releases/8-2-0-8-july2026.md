...
<!-- TODO (DOC-6687): complete this table from the CRD diff between operator v8.0.20 and v8.2.0. Confirm the exact REC field name for dmc_external_cba_authentication (RED-195771). -->

| **CRD** | **Field** | **Change** | **Description** |
|---|---|---|---|
| RedisEnterpriseRole (`rerole`) | — | Added | New CRD for managing Redis Enterprise roles. |
| RedisEnterpriseRoleBinding (`rerolebinding`) | — | Added | New CRD for binding Redis Enterprise roles to users. |
| REDB | `spec.tags` | Added | Map of tags used to enrich exported database metrics. |
| REAADB | `spec.tags` | Added | Map of tags used to enrich exported database metrics. |
