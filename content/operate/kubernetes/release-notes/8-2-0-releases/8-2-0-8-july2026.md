...
hideListLinks: true
linkTitle: 8.2.0-8 (July 2026)
title: Redis Enterprise for Kubernetes 8.2.0-8 (July 2026) release notes
weight: 27
---

Redis Enterprise for Kubernetes 8.2.0-8 is a feature release that supports [Redis Software 8.2.0]({{<relref "/operate/rs/release-notes/" >}})<!-- TODO: retarget to /operate/rs/release-notes/rs-8-2-releases/ once the RS 8.2.0 notes land (DOC-6645) --> and includes new features, bug fixes, and enhancements.
...
| Kubernetes | **Redis <nobr>8.2.0-8</nobr>** |
|---|---|
| 1.36 | Supported |
| 1.35 | Supported |
| 1.34 | Supported |
...
<!-- TODO: swap to the GA build numbers Monday (grep -rn "8.2.0-8" and "8.2.0-23"). -->

- **Redis Enterprise**: `redislabs/redis:8.2.0-23.8` (`redislabs/redis:8.2.0-23.8.minimal` for minimal base image)
- **Operator**: `redislabs/operator:8.2.0-8`
- **Services Rigger**: `redislabs/k8s-controller:8.2.0-8`
- **Call Home Client**: `redislabs/re-call-home-client:8.2.0-8`

### OpenShift downloads

- **OLM operator bundle**: `8.2.0-8.0`
- **Redis Enterprise**: `registry.connect.redhat.com/redislabs/redis-enterprise:8.2.0-23.8` (`registry.connect.redhat.com/redislabs/redis-enterprise:8.2.0-23.8.minimal` for minimal base image)
- **Operator**: `registry.connect.redhat.com/redislabs/redis-enterprise-operator:8.2.0-8`
- **Services Rigger**: `registry.connect.redhat.com/redislabs/services-manager:8.2.0-8`
- **Call Home Client**: `registry.connect.redhat.com/redislabs/call-home-client:8.2.0-8`
