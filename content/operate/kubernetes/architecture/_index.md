...
{{< image filename="/images/rs/kubernetes-overview-layered-orchestration.png" >}}
...
{{< image filename="/images/rs/kubernetes-overview-unified-deployment.png" >}}
...
{{< image filename="/images/rs/kubernetes-overview-network-attached-persistent-storage.png" >}}
...
{{< image filename="/images/rs/kubernetes-overview-performance-improvements-read.png" >}}{{< image filename="/images/rs/kubernetes-overview-performance-improvements-write.png" >}}
...
{{< image filename="/images/rs/kubernetes-overview-multiple-services-per-pod.png" >}}
