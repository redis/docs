...
- docs.redis.com
  - [Metrics in Prometheus]({{< relref "/operate/rs/clusters/monitoring/prometheus-metrics-definitions.md" >}})
  - [Monitoring and metrics]({{< relref "/operate/rs/clusters/monitoring/_index.md" >}})
