...
Redis 7.0 makes pub/sub restrictive and blocks access to all channels in source available Redis. However, Redis Cloud still defaults to permissive pub/sub even for Redis 7.0 subscriptions.
