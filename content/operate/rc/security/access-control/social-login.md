...
1. Select **Google** from the [sign-in](https://cloud.redis.io/new/) screen.
...
1. Select **Github** from the [sign-in](https://cloud.redis.io/new/) screen.
...
1. Select **Google** on the [sign-in](https://cloud.redis.io/new/) screen.
...
1. Select **Github** on the [sign-in](https://cloud.redis.io/new/) screen.
