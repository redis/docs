...
| **Public endpoint access** | Select whether or not to [block public endpoints]({{< relref "/operate/rc/security/network-security/block-public-endpoints" >}}) for all databases in the subscription.  |
