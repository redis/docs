...
| **CIDR allow list**                | [Allow list]({{< relref "/operate/rc/security/network-security/cidr-whitelist.md" >}}) of IP addresses/security groups permitted to access the database |
