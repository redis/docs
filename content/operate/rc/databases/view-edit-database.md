...
| **Public endpoint**       | Public URI used by any application or client to access the database. Redis Cloud Pro databases can [block the public endpoint]({{< relref "/operate/rc/security/network-security/block-public-endpoints" >}}).                                                  |
...
| **CIDR allow list** | [Allow list]({{< relref "/operate/rc/security/network-security/cidr-whitelist.md" >}}) of IP addresses/security groups permitted to access the database. (_Paid plans only_)                    |
