...
{{<tip>}}
To make sure your applications reconnect to your database quickly after maintenance, see [Develop highly available and resilient apps with Redis Cloud]({{< relref "/operate/rc/resilient-apps" >}}).
{{</tip>}}
