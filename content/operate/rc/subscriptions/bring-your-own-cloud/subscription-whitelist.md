...
If you use [Redis Cloud Bring your Own Cloud](/content/operate/rc/subscriptions/bring-your-own-cloud/_index.md) to host your Redis Cloud deployment, you can configure a subscription-wide allow list
...
> [!NOTE]
> The subscription-level allow list is available for Redis Cloud Bring your Own Cloud. If you don't have Redis Cloud Bring your Own Cloud, you can configure a [CIDR allow list](/content/operate/rc/security/cidr-whitelist.md) for each database.
