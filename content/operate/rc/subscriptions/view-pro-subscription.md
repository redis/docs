...
- Set up a [VPC peering]({{< relref "/operate/rc/security/network-security/connect-private-endpoint/vpc-peering.md" >}}) relationship between the virtual private cloud (VPC) hosting your subscription and another VPC.
...
- Set up [Private Service Connect]({{< relref "/operate/rc/security/network-security/connect-private-endpoint/private-service-connect" >}}) (*Google Cloud only*), [Transit Gateway]({{< relref "/operate/rc/security/network-security/connect-private-endpoint/aws-transit-gateway" >}}) (*AWS only*), or [AWS PrivateLink]({{< relref "/operate/rc/security/network-security/connect-private-endpoint/aws-privatelink" >}}) (*AWS only*).
