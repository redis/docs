...
| **User for this service** | The [database access user]({{< relref "/operate/rc/security/data-access-control/role-based-access-control" >}}) to use for this service. LangCache only supports the [`default` user]({{< relref "/operate/rc/security/data-access-control/default-user" >}}) during public preview. |
