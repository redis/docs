...
Redis 7.4 offers hash field expiration and other feature set improvements. For more information on the changes in Redis 7.4, see [What's new in Redis 7.4](/content/develop/whats-new/7-4.md).
...
If you're upgrading from Redis 6.4, also review the [Redis 7.2 breaking changes](/content/operate/rc/changelog/version-release-notes/7-2.md#breaking-changes) before upgrading.
