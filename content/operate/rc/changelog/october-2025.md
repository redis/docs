...
Redis Cloud now supports [Redis Data Integration (RDI)](/content/operate/rc/rdi/_index.md) to create data pipelines that ingest data from a supported primary database to Redis. 
