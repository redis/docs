...
When you create a Pro database with [Search and query](/content/operate/oss_and_stack/stack-with-enterprise/search/_index.md) capabilities, you can now choose to boost your query capabilities with the Query performance factor. The query performance factor adds dedicated power specifically for Search and query. For more information, see [Search and query sizing](/content/operate/rc/databases/configuration/advanced-capabilities.md#search-and-query-sizing).
...
A preview of Redis 7.4 is now available on [Redis Cloud Essentials databases](/content/operate/rc/databases/create-database/create-essentials-database.md) in select regions on Amazon Web Services and Google Cloud.
