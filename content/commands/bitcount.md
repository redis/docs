...
Like for the [`GETRANGE`](/content/commands/getrange.md) command start and end can contain negative values in
...
Using the [`SETBIT`](/content/commands/setbit.md) command this is trivial to accomplish, identifying every day
...
the current day the user visited the web site using the [`SETBIT`](/content/commands/setbit.md) command setting
...
command like [`GET`](/content/commands/get.md) or [`INCR`](/content/commands/incr.md).
