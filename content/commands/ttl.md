...
See also the [`PTTL`](/content/commands/pttl.md) command that returns the same information with milliseconds resolution (Only available in Redis 2.6 or greater).
