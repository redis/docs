...
Cluster note: in a Redis Cluster, [`PUBSUB`](/content/commands/pubsub.md)'s replies in a cluster only report information from the node's Pub/Sub context, rather than the entire cluster.
