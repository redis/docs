...
The reply format is identical to that of [`CLIENT LIST`](/content/commands/client-list.md), and the content consists only of information about the current client.
