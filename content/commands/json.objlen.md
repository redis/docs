...
- An [array reply](/content/develop/reference/protocol-spec.md#arrays) where each array element corresponds to one match:
  ...
  - An [integer reply](/content/develop/reference/protocol-spec.md#integers): the number of keys in the object.
...
- An [integer reply](/content/develop/reference/protocol-spec.md#integers): the number of keys in the first match.
