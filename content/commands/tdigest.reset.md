...
* [Simple error reply](/content/develop/reference/protocol-spec.md#simple-errors) in these cases: key does not exist or is of the wrong type, or incorrect number of arguments.
