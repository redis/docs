...
* [Array reply](/content/develop/reference/protocol-spec.md#arrays) of 
  * Without `AGGREGATION` or with a single aggregator:
    ([Integer reply](/content/develop/reference/protocol-spec.md#integers), [Simple string reply](/content/develop/reference/protocol-spec.md#simple-strings)) pairs representing (timestamp, value).
  * With multiple aggregators:
    ([Integer reply](/content/develop/reference/protocol-spec.md#integers), multiple [Simple string reply](/content/develop/reference/protocol-spec.md#simple-strings)) tuples representing (timestamp, value...).
...
* [Array reply](/content/develop/reference/protocol-spec.md#arrays) of
  * Without `AGGREGATION` or with a single aggregator:
    ([Integer reply](/content/develop/reference/protocol-spec.md#integers), [Double reply](/content/develop/reference/protocol-spec.md#doubles)) pairs representing (timestamp, value).
  * With multiple aggregators:
    ([Integer reply](/content/develop/reference/protocol-spec.md#integers), multiple [Double reply](/content/develop/reference/protocol-spec.md#doubles)) tuples representing (timestamp, value...).    
* [Simple error reply](/content/develop/reference/protocol-spec.md#simple-errors) in these cases: invalid filter value, wrong key type, key does not exist, etc.
...
[`TS.MRANGE`](/content/commands/ts.mrange.md) | [`TS.REVRANGE`](/content/commands/ts.revrange.md) | [`TS.MREVRANGE`](/content/commands/ts.mrevrange.md)
