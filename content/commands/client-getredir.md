...
[tracking](/content/develop/clients/client-side-caching.md#tracking) notifications to. We set a client
to redirect to when using [`CLIENT TRACKING`](/content/commands/client-tracking.md) to enable tracking. However in
