...
- `ignoreMaxTimeDiff` and `ignoreMaxValDiff` cannot be specified as with [`TS.ADD`]({{< baseurl >}}/commands/ts.add/), however, the same logic still applies based on the values of the per-key configuration parameters.
</note>
