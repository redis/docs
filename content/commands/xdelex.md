...
* [Array reply](../../develop/reference/protocol-spec#arrays): For each ID:
    ...
    * [Integer reply](../../develop/reference/protocol-spec#integers): 2 if the entry was not deleted: there are still existing references (ACKED option). Also if there are no consumer groups.
