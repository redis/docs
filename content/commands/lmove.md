...
This command comes in place of the now deprecated [`RPOPLPUSH`](/content/commands/rpoplpush.md). Doing
...
`LMOVE` (or [`BLMOVE`](/content/commands/blmove.md) for the blocking variant) offers a way to avoid
