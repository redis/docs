...
---
The `CLIENT GETNAME` returns the name of the current connection as set by [`CLIENT SETNAME`](/content/commands/client-setname.md). Since every new connection starts without an associated name, if no name was assigned nil is returned.
