...
For an introduction to the HyperLogLog data structure check its  [data structure page](/content/develop/data-types/probabilistic/hyperloglogs.md) and the [`PFCOUNT`](/content/commands/pfcount.md) command page.
