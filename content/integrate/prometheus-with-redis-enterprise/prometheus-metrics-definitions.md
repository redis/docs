...
| <span class="break-all">redis_server_search_cursors_internal_activ</span> | The total number of coordinator cursors in the shard, either holding pending results or actively executing `FT.CURSOR READ`. <sup>[3](#tnote-3)</sup> |
...
| <span class="break-all">redis_server_search_cursors_user_active</span> | The total number of users cursors in the shard, either holding pending results or actively executing `FT.CURSOR READ`. <sup>[3](#tnote-3)</sup> |
