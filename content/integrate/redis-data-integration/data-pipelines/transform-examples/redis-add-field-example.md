...
[`add_field`](/content/integrate/redis-data-integration/reference/data-transformation/add_field.md) transformation.
...
field with the
[JMESPath](/content/integrate/redis-data-integration/reference/jmespath-custom-functions.md) function `regex_replace()`.
...
[`remove_field`](/content/integrate/redis-data-integration/data-pipelines/transform-examples/redis-remove-field-example.md)
