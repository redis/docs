...
For more examples of how to manipulate date and time values, see [Formatting date and time values](/content/integrate/redis-data-integration/data-pipelines/transform-examples/formatting-date-and-time-values.md).
