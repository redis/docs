...
- `opcode` - The operation code. See [Using the operation code](/content/integrate/redis-data-integration/data-pipelines/transform-examples/redis-opcode-example.md) for more information about the possible opcode values and how to use them.
