...
- `transform`: This is an optional section describing the transformation that the pipeline
  ...
  *transformation block* that will use the parameters supplied in the `with` section. See the 
  [data transformation reference](/content/integrate/redis-data-integration/1.19.1/reference/data-transformation/_index.md)
  for more details about the supported transformation blocks. See also the
  [JMESPath custom functions](/content/integrate/redis-data-integration/1.19.1/reference/jmespath-custom-functions.md)
  ...
  [dry run](/content/integrate/redis-data-integration/1.19.1/reference/api-reference.md#tag/secure/operation/job_dry_run_api_v1_pipelines_jobs_dry_run_post)
  feature in the API.
  ...
  >
  > See [Row Format](/content/integrate/redis-data-integration/1.19.1/data-pipelines/transform-examples/redis-row-format.md#full) for a more detailed explanation of the full format.
...
- `output`: This is a mandatory section to specify the data structure(s) that
  ...
  [Data denormalization](/content/integrate/redis-data-integration/1.19.1/data-pipelines/data-denormalization.md)
  ...
  - `with`:
   ...
   `sorted_set`, `stream` and `string`.
    ...
    - `expire`: Positive integer value or SQL/JMESPath expression indicating a number of seconds
      ...
      See [Set custom expiration times / TTL](/content/integrate/redis-data-integration/1.19.1/data-pipelines/transform-examples/redis-expiration-example.md) for more information and examples.
...
using the
[`rename_field`](/content/integrate/redis-data-integration/1.19.1/reference/data-transformation/rename_field.md) block. It also demonstrates how you can set the key of this record instead of relying on
the default logic.
...
See the
[RDI configuration file](/content/integrate/redis-data-integration/1.19.1/reference/config-yaml-reference.md)
