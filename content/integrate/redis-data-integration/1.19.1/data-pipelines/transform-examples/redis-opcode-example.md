...
The opcode is only available in the [full row format](/content/integrate/redis-data-integration/1.19.1/data-pipelines/transform-examples/redis-row-format.md#full), and can be accessed in the `transform` and `output` sections of the job file.
