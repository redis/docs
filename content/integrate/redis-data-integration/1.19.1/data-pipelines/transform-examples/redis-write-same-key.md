...
[`row_format: full`](/content/integrate/redis-data-integration/1.19.1/data-pipelines/transform-examples/redis-row-format.md#full)
so the job can inspect the
[`opcode`](/content/integrate/redis-data-integration/1.19.1/data-pipelines/transform-examples/redis-opcode-example.md),
