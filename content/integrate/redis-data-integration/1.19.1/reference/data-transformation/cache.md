...
- The expression in [`add_field`](/content/integrate/redis-data-integration/1.19.1/reference/data-transformation/add_field.md) (single-field and per-item form).
- The expression in [`filter`](/content/integrate/redis-data-integration/1.19.1/reference/data-transformation/filter.md).
- The expression in [`map`](/content/integrate/redis-data-integration/1.19.1/reference/data-transformation/map.md).
- The argument expressions in [`redis.lookup`](/content/integrate/redis-data-integration/1.19.1/reference/data-transformation/lookup.md). The same block accepts a `lookup_cache:` variant that caches the lookup result returned by Redis.
