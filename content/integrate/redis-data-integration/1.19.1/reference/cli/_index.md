...
installation types: [VM](/content/integrate/redis-data-integration/1.19.1/installation/install-vm.md),
[Kubernetes](/content/integrate/redis-data-integration/1.19.1/installation/install-k8s.md), and Redis Cloud.
...
> see [Compare the previous and current RDI CLI](/content/integrate/redis-data-integration/1.19.1/reference/cli/previous-cli-comparison.md)
...
Use the [`set-context`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-set-context.md)
and [`use-context`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-use-context.md)
...
- **Information**: [`info`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-info.md).
- **Pipelines**: [`list`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-list.md),
  [`get`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-get.md),
  [`describe`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-describe.md) (alias `status`),
  [`deploy`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-deploy.md) (alias `set`),
  [`delete`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-delete.md),
  [`start`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-start.md),
  [`stop`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-stop.md), and
  [`reset`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-reset.md).
- **Secrets**: [`list-secrets`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-list-secrets.md),
  ...
  [`set-secret`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-set-secret.md), and
  [`delete-secret`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-delete-secret.md).
- **Dead-letter queues**: [`list-dlqs`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-list-dlqs.md),
  [`get-dlq`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-get-dlq.md), and
  [`list-dlq-records`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-list-dlq-records.md) (alias `get-rejected`).
- **Jobs**: [`list-jobs`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-list-jobs.md),
  [`get-job`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-get-job.md), and
  [`describe-job`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-describe-job.md).
- **Metric collections**: [`list-metric-collections`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-list-metric-collections.md) and
  [`get-metric-collection`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-get-metric-collection.md).
- **Scaffolding**: [`scaffold`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-scaffold.md)
- **Contexts**: [`list-contexts`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-list-contexts.md),
  [`describe-context`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-describe-context.md),
  [`set-context`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-set-context.md),
  [`use-context`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-use-context.md), and
  [`delete-context`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-delete-context.md).

On VM installations, the CLI also exposes the
[`configure-rdi`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-configure-rdi.md) and
[`dump-support-package`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-dump-support-package.md)
administration commands.

See the [`redis-di`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di.md) page for the
