...
`--password`. See the [CLI reference overview](/content/integrate/redis-data-integration/1.19.1/reference/cli/_index.md#connecting-to-the-api)
...
The standard VM [`upgrade.sh`](/content/integrate/redis-data-integration/1.19.1/installation/upgrade.md#upgrading-a-vm-installation)
