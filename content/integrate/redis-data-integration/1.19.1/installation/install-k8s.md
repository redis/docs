...
[Install RDI on VMs](/content/integrate/redis-data-integration/1.19.1/installation/install-vm.md).
...
You manage RDI with the [`redis-di` CLI](/content/integrate/redis-data-integration/1.19.1/reference/cli/_index.md),
...
> [!NOTE]
> Please see [these docs](/content/integrate/redis-data-integration/1.19.1/data-pipelines/prepare-dbs/spanner.md#6-additional-kubernetes-configuration) if this RDI installation is for use with GCP Spanner.
...
[`redis-di info`](/content/integrate/redis-data-integration/1.19.1/reference/cli/redis-di-info.md)
