...
[VM installation guide](/content/integrate/redis-data-integration/installation/install-vm.md).
...
[Pipelines](/content/integrate/redis-data-integration/data-pipelines/_index.md) for more information). Use Redis Insight to open
...
[`redis-di`](/content/integrate/redis-data-integration/reference/cli/_index.md)
...
certificate (see the
[reference page](/content/integrate/redis-data-integration/reference/cli/redis-di-set-context.md)
...
[list](/content/integrate/redis-data-integration/reference/cli/redis-di-list-contexts.md)
and [delete](/content/integrate/redis-data-integration/reference/cli/redis-di-delete-context.md)
contexts.
...
See [Deploy a pipeline](/content/integrate/redis-data-integration/data-pipelines/deploy.md)
...
and the
[ingest pipeline lifecycle](/content/integrate/redis-data-integration/data-pipelines/_index.md#pipeline-lifecycle)
