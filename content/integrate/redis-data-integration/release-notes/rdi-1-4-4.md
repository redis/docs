...
-   Installation on [Kubernetes](/content/integrate/redis-data-integration/installation/install-k8s.md) using a [Helm chart](https://helm.sh/docs/). You can install on [OpenShift](https://docs.openshift.com/) or other flavours of K8s using Helm.
