...
- rs
description: |
  New Flink-based stream processor for Kubernetes deployments, with horizontal scaling, Flink checkpointing, and significantly higher throughput.
