...
- **Backpressure mechanism** - RDI is designed to backoff writing data when the cache gets
  ...
  disconnection. See [Backpressure mechanism](/content/integrate/redis-data-integration/architecture/_index.md#backpressure-mechanism) for more information.
...
[When to use RDI](/content/integrate/redis-data-integration/when-to-use.md)
