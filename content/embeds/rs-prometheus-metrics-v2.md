...
| <span class="break-all">redis_server_hashes_items_under_1M</span> | Number of hash keys with an element count under 1M |
| <span class="break-all">redis_server_hashes_items_1M_to_8M</span> | Number of hash keys with an element count between 1M and 8M |
| <span class="break-all">redis_server_hashes_items_over_8M</span> | Number of hash keys with an element count over 8M |
...
| <span class="break-all">redis_server_lists_items_under_1M</span> | Number of list keys with an element count under 1M |
| <span class="break-all">redis_server_lists_items_1M_to_8M</span> | Number of list keys with an element count between 1M and 8M |
| <span class="break-all">redis_server_lists_items_over_8M</span> | Number of list keys with an element count over 8M |
...
| <span class="break-all">redis_server_sets_items_under_1M</span> | Number of set keys with an element count under 1M |
| <span class="break-all">redis_server_sets_items_1M_to_8M</span> | Number of set keys with an element count between 1M and 8M |
| <span class="break-all">redis_server_sets_items_over_8M</span> | Number of set keys with an element count over 8M |
...
| <span class="break-all">redis_server_zsets_items_under_1M</span> | Number of sorted set keys with an element count under 1M |
| <span class="break-all">redis_server_zsets_items_1M_to_8M</span> | Number of sorted set keys with an element count between 1M and 8M |
| <span class="break-all">redis_server_zsets_items_over_8M</span> | Number of sorted set keys with an element count over 8M |
