...
Confirm your Redis database version (`redis_version`) using the admin console or run the following [`INFO`](https://redis.io/commands/info/) command via [`redis-cli`]({{< relref "/operate/rs/references/cli-utilities/redis-cli" >}}):
