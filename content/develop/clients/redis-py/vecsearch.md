...
[Redis Search](/develop/ai/search-and-query)
lets you index vector fields in [hash](/develop/data-types/hashes)
or [JSON](/develop/data-types/json) objects (see the
[Vectors](/develop/ai/search-and-query/vectors) 
reference page for more information).
Among other things, vector fields can store *text embeddings*, which are AI-generated vector
representations of the semantic information in pieces of text. The
[vector distance](/develop/ai/search-and-query/vectors#distance-metrics)
...
Install [`redis-py`](/develop/clients/redis-py) if you
...
[tag](/develop/ai/search-and-query/advanced-concepts/tags)
field to represent the "genre" of the text, and the embedding vector generated from
the original text content. The `embedding` field specifies
[HNSW](/develop/ai/search-and-query/vectors#hnsw-index)
indexing, the
[L2](/develop/ai/search-and-query/vectors#distance-metrics)
...
when you add them with [`hset()`](/commands/hset), as long as
...
(see
[Vector search](/develop/ai/search-and-query/query/vector-search)
...
you must supply a [path](/develop/data-types/json/path) in the schema
...
Use [`json().set()`](/commands/json.set) to add the data
instead of [`hset()`](/commands/hset). The dictionaries
