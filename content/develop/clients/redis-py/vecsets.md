...
A Redis [vector set](/develop/data-types/vector-sets) lets
...
[Redis for AI](/develop/ai) to learn more about text
...
[`vadd()`](/commands/vadd) command to set the embedding.
...
[`vemb()`](/commands/vemb) to retrieve the embedding,
...
[hash vector indexing](/develop/ai/search-and-query/vectors)).
...
or by using the [`vgetattr()`](/commands/vgetattr) method.
...
the query vector to [`vsim()`](/commands/vsim) to return elements
...
You can also use
[filter expressions](/develop/data-types/vector-sets/filtered-search)
...
See the [vector sets](/develop/data-types/vector-sets)
docs for more information and code examples. See the
[Redis for AI](/develop/ai) section for more details
about text embeddings and other AI techniques you can use with Redis.

You may also be interested in
[vector search](/develop/clients/redis-py/vecsearch).
This is a feature of
[Redis Search](/develop/ai/search-and-query)
that lets you retrieve
[JSON](/develop/data-types/json) and
[hash](/develop/data-types/hashes) documents based on
