...
[probabilistic data types](/develop/data-types/probabilistic)
...
-   [Membership](#set-membership): The
    [Bloom filter](/develop/data-types/probabilistic/bloom-filter) and
    [Cuckoo filter](/develop/data-types/probabilistic/cuckoo-filter)
    data types let you track whether or not a given item is a member of a set.
-   [Cardinality](#set-cardinality): The
    [HyperLogLog](/develop/data-types/probabilistic/hyperloglogs)
...
Instead of storing strings directly, like a [set](/develop/data-types/sets),
...
A [HyperLogLog](/develop/data-types/probabilistic/hyperloglogs)
...
A [Count-min sketch](/develop/data-types/probabilistic/count-min-sketch)
...
[sorted set](/develop/data-types/sorted-sets)
...
A [t-digest](/develop/data-types/probabilistic/t-digest)
...
A [Top-K](/develop/data-types/probabilistic/top-k)
