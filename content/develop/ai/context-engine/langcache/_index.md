...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 my-8">
  {{< image-card image="images/ai-brain.svg" alt="Concepts icon" title="Concepts — Why a cache hit isn't binary anymore, and how to choose a similarity threshold" url="/develop/ai/context-engine/langcache/concepts" >}}
