...
You can add number fields to a schema in [`FT.CREATE`](/content/commands/ft.create.md) using this syntax:
...
\* New syntax as of RediSearch v2.10. Requires [`DIALECT 2`](/content/develop/ai/search-and-query/advanced-concepts/dialects.md#dialect-2). 
...
You can add geo fields to the schema in [`FT.CREATE`](/content/commands/ft.create.md) using this syntax:
...
[`FT.CREATE`](/content/commands/ft.create.md) using the following syntax:
...
You can add vector fields to the schema in [`FT.CREATE`](/content/commands/ft.create.md) using this syntax:
...
Notice that `{count}` represents the total number of attribute pairs passed in the command. Algorithm parameters should be submitted as named arguments. 
    ...
    Here, three parameters are passed for the index ([`TYPE`](/content/commands/type.md), `DIM`, `DISTANCE_METRIC`), and `count` is the total number of attributes (6).
...
For more information about vector fields, see [vector fields](/content/develop/ai/search-and-query/vectors/_index.md).
...
For more information about tag fields, see [Tag Fields](/content/develop/ai/search-and-query/advanced-concepts/tags.md).
