...
> [!NOTE]
> If you're using Redis Software or Redis Cloud, see the [best practices for scalable Redis Search](/content/operate/oss_and_stack/stack-with-enterprise/search/scalable-query-best-practices.md) page.
...
* Review [`FT.INFO`](/content/commands/ft.info.md) and [`FT.PROFILE`](/content/commands/ft.profile.md) outputs for anomalies and/or errors.
...
### General
- Favor [`TAG`](/content/develop/ai/search-and-query/indexing/field-and-type-options.md#tag-fields) over [`NUMERIC`](/content/develop/ai/search-and-query/indexing/field-and-type-options.md#numeric-fields) for use cases that only require matching.
- Favor [`TAG`](/content/develop/ai/search-and-query/indexing/field-and-type-options.md#tag-fields) over [`TEXT`](/content/develop/ai/search-and-query/indexing/field-and-type-options.md#text-fields) for use cases that don’t require full-text capabilities (pure match).

### Non-threaded search
- Put only those fields used in your queries in the index.
- Only make fields [`SORTABLE`](/content/develop/ai/search-and-query/advanced-concepts/sorting.md) if they are used in [`SORTBY`](/content/develop/ai/search-and-query/advanced-concepts/sorting.md#specifying-sortby)
queries.
- Use [`DIALECT 2`](/content/develop/ai/search-and-query/advanced-concepts/dialects.md#dialect-2).
...
- Set TAG fields to [UNF](/content/develop/ai/search-and-query/advanced-concepts/sorting.md#normalization-unf-option).
...
You can analyze [`FT.PROFILE`](/content/commands/ft.profile.md) output to gain insights about query execution.
...
- [`DIALECT 2`](/content/develop/ai/search-and-query/advanced-concepts/dialects.md#dialect-2): enables the latest Redis Search syntax and features, ensuring compatibility with modern capabilities.
