...
Redis 8.6 introduces powerful idempotency features for [Redis Streams](/content/develop/data-types/streams/_index.md) that provide at-most-once delivery guarantees:
...
Redis 8.6 introduces new [eviction policies](/content/develop/reference/eviction/index.md) that provide more granular control over memory management:
...
The new [`HOTKEYS`](/content/commands/hotkeys.md) commands enable real-time detection and reporting of frequently accessed keys. This feature helps identify performance bottlenecks and optimize data distribution in clustered environments.
...
Redis 8.6 extends [time series](/content/develop/data-types/timeseries/_index.md) functionality with:
...
- [Redis 8.6](/content/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.6-release-notes.md)
