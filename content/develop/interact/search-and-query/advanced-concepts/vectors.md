...
Redis maintains one or more secondary indexes over your data. When you define the schema for the index, you can include one or more vector fields using the [`FT.CREATE`]({{< baseurl >}}/commands/ft.create/) command.
