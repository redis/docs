...
This guide shows you how to implement a Redis-backed session store in PHP with [Predis](/content/develop/clients/php/_index.md). It includes a small local web server using PHP's built-in development server so you can see the session lifecycle end to end.
...
* [PHP client guide](/content/develop/clients/php/_index.md)
