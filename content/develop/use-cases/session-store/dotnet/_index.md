...
This guide shows you how to implement a Redis-backed session store in .NET with [`StackExchange.Redis`](/content/develop/clients/dotnet/_index.md). It includes a small local web server built with ASP.NET Core minimal APIs so you can see the session lifecycle end to end.
...
* [.NET client guide](/content/develop/clients/dotnet/_index.md)
