...
This guide shows you how to build a compact rolling sensor graph demo in Python with [`redis-py`](/content/develop/clients/redis-py/_index.md) and Redis time series support. The example simulates three power sensors, ingests readings into Redis, and serves a local browser dashboard that updates in real time.
...
* [redis-py guide](/content/develop/clients/redis-py/_index.md) - Install and use the Python client
