...
This guide shows you how to build a compact rolling sensor graph demo in Ruby with [`redis-rb`](/content/develop/clients/ruby/_index.md) and Redis time series support. The example simulates three power sensors, ingests readings into Redis, and serves a local browser dashboard that updates in real time.
...
* [Ruby client guide](/content/develop/clients/ruby/_index.md) - Install and use the Ruby client
