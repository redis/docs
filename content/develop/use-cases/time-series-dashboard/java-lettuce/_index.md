...
This guide shows you how to build a compact rolling sensor graph demo in Java with [`Lettuce`](/content/develop/clients/lettuce/_index.md) and Redis time series support. The example simulates three power sensors, ingests readings into Redis, and serves a local browser dashboard that updates in real time.
...
* For a synchronous Java version of this dashboard, see [Jedis](/content/develop/use-cases/time-series-dashboard/java-jedis/_index.md)
...
* [Lettuce guide](/content/develop/clients/lettuce/_index.md) - Install and use the Java client
