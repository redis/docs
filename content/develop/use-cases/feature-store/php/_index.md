...
in PHP with [Predis](/content/develop/clients/php/_index.md). The demo runs
...
a Lua script via [`EVAL`](/content/commands/eval.md) /
...
[transactions and pipelining](/content/develop/clients/php/transpipe.md),
TLS, AUTH, error handling — see the
[Predis client guide](/content/develop/clients/php/_index.md) and the
[connect recipe](/content/develop/clients/php/connect.md).
...
* [`HMGET`](/content/commands/hmget.md) to retrieve any subset
...
See the [Predis documentation](/content/develop/clients/php/_index.md)
