 ...
 *
 * Usage:
 *     javac -cp lettuce-core.jar TokenBucket.java DemoServer.java
 *     java -cp .:lettuce-core.jar DemoServer [--port PORT] [--redis-host HOST] [--redis-port PORT]
 */
...
public class DemoServer {
    ...
    public static void main(String[] args) {
        ...
        limiter = new TokenBucket(capacity, refillRate, refillInterval, connection.sync());
