...
* [`PUBLISH`](/content/commands/publish.md) on `queue:jobs-jedis:events` for completion signalling
* [Lua scripting](/content/develop/programmability/eval-intro.md) ([`EVAL`](/content/commands/eval.md)) for the complete, fail, and reclaim flows so each runs atomically against the processing list and metadata hash
...
See the [Jedis documentation](/content/develop/clients/jedis/_index.md) for full client reference.
