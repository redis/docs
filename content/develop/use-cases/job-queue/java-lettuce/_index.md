...
* [Lua scripting](/content/develop/programmability/eval-intro.md) ([`EVAL`](/content/commands/eval.md)) for the enqueue, complete, fail, and reclaim flows so each runs atomically against the processing list and metadata hash
...
* [`EVAL`](/content/commands/eval.md) for atomic enqueue, complete, fail, and reclaim flows.

See the [Lettuce documentation](/content/develop/clients/lettuce/_index.md) for full client reference.
