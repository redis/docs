...
In a real system the in-process channel is replaced by a CDC pipeline — [Redis Data Integration](/content/integrate/redis-data-integration/_index.md), Debezium plus a lightweight consumer, or an equivalent tool that tails the source's binlog/WAL and pushes events into Redis.
...
* [go-redis guide](/content/develop/clients/go/_index.md) - Install and use the Go Redis client
