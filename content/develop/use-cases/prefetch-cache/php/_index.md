...
In a real system, the Redis-list change feed is replaced by a CDC pipeline — [Redis Data Integration](/content/integrate/redis-data-integration/_index.md), Debezium plus a lightweight consumer, or an equivalent tool that tails the source's binlog/WAL and pushes events into Redis.
...
* [BRPOP command](/content/commands/brpop.md) - Block on a list for the next change event
