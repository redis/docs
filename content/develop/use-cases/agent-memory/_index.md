...
-   Recall long-term memories by semantic similarity instead of exact key, scoped per user, agent, or namespace.
-   Prevent memory bloat through write-time deduplication, summarization, and background consolidation.
