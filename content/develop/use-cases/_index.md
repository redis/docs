...
* [Memory layer]({{< relref "/develop/use-cases/memory-layer" >}}) - Give AI agents persistent memory that spans sessions and tasks — working memory per thread, long-term semantic recall, and a time-ordered event log on one Redis instance
