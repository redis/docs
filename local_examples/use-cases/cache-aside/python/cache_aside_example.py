# EXAMPLE: cache_aside_basic
"""Complete example of cache-aside pattern implementation using Redis JSON."""
...
def main():
    ...
    from cache_aside import get_ttl, refresh_ttl
    ...
    data = get_data_with_fallback(
        redis_client, 'user:1', data_store.get, prefix='example:'
    )
