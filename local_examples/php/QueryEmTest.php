...
// REMOVE_END
{
    public function testQueryEm() {
        ...
        // STEP_START em1
        $res1 = $r->ftSearch('idx:bicycle', '@price:[270]');
        echo $res1[0] . PHP_EOL; // >>> 1
        ...
        $args2->searchFilter(['price', 270, 270]);
        ...
        // STEP_END
        // REMOVE_START
        $this->assertEquals(1, $res1[0]);
        $this->assertEquals('bicycle:0', $docs1Ids[0]);

        $this->assertEquals(1, $res2[0]);
        $this->assertEquals('bicycle:0', $docs2Ids[0]);
        // REMOVE_END

        // STEP_START em2
        $res3 = $r->ftSearch('idx:bicycle', '@condition:{new}');
        ...
        // REMOVE_START
        sort($docs3Ids);
        $this->assertEquals(['bicycle:0','bicycle:5','bicycle:6','bicycle:7','bicycle:8'], $docs3Ids);
        // REMOVE_END

        // STEP_START em3
        
        // Search syntax not currently supported in Predis.

        // STEP_END

        // STEP_START em4
        $res5 = $r->ftSearch('idx:bicycle', '@description:"rough terrain"');
        ...
        $this->assertEquals('bicycle:8', $docs5Ids[0]);
        // REMOVE_END
    }
}
