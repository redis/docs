 ...
 * collect_context.js
 *
 * Reads the GitHub Actions event payload and extracts a normalised context
 * object (title, body, changed files, author, etc.) for push and pull_request
 * events. Writes the result to /tmp/memory_context.json for use by the
 * subsequent retrieve_memory.js step.
 *
 * No secrets required — uses standard GITHUB_* environment variables
 * injected automatically by the Actions runner.
 */
'use strict';
